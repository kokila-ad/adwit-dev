...
var TableAdvanced = function () {
    ...
    var initTable3 = function () {
        ...
        function fnFormatDetails(oTable, nTr) {
            ...
            sOut += '<tr> <td class="row"><div class="col-md-6 no-border margin-top-5"><p class=" margin-left-25">' + aData[1] + '</p></div><div class="col-md-4 col-md-offset-2 no-border margin-top-10">' + aData[2] + '</div></td></tr>';
			//sOut += '<tr> <td col-span="4" class="col-md-8"><p class=" margin-left-25 margin-top-5">' + aData[1] + '</p></td> <td class="float-right">' + aData[2] + '</td> </tr>';
            //sOut += '<tr><td>Attachments: ' + aData[2] + '</td></tr>';
    ...
    var initTable5 = function () {
        ...
        var oTable = table.dataTable({
            "dom": "<'row margin-0'<'col-md-6 col-sm-12 display-none'l><'col-md-8 col-md-offset-3 padding-10 col-sm-12'f>r>t<'row display-none'<'col-md-5 col-sm-12'i><'col-md-7 col-sm-12'p>>", // datatable layout without  horizobtal scroll
            //"scrollY": "300",
            "deferRender": true,
            "order": [
                [0, 'asc']
