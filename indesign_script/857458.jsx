var myDocument = app.documents.add();
                            ...
                            var myTextFrame = myDocument.pages.item(0).textFrames.add();
                                ...
                                myTextFrame.contents = "Please see attached file for pick up .\r\nChange the train box to read 28 Days Until Christmas.\r\nIn the second car please use a graphic of a Christmas tree only and change the location to Co-op Agro Centre.\r\nIn the 3rd car please use a graphic of a Christmas present and text that says:\r\nThis year give the gift that keeps on giving. Give a Subscription to the Assiniboia Times.";