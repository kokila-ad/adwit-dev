var myDocument = app.documents.add();
                            // set in inches
                            myDocument.pages.everyItem().resize(CoordinateSpaces.INNER_COORDINATES,AnchorPoint.CENTER_ANCHOR,ResizeMethods.REPLACING_CURRENT_DIMENSIONS_WITH,[72*3.1667,72*2.5]);
                            ...
                            var myTextFrame = myDocument.pages.item(0).textFrames.add();
                                ...
                                myTextFrame.contents = 'In loving memory of Sally Starycki
July 1 1933-December 2, 2019

Deep in our hearts
you are fondly remembered
Though on earth you areno more
But in our memory
you are with us
As you always were
Always loved and forever missed
By Daughters Darlene and family, Chris and family';