var myDocument = app.documents.add();
                            // set in inches
                            myDocument.pages.everyItem().resize(CoordinateSpaces.INNER_COORDINATES,AnchorPoint.CENTER_ANCHOR,ResizeMethods.REPLACING_CURRENT_DIMENSIONS_WITH,[72*5,72*5.75]);
                            ...
                            var myTextFrame = myDocument.pages.item(0).textFrames.add();
                                ...
                                myTextFrame.contents = "1) Please change both expiration dates to 12\/24\/2020.  2) Change the headline to say this: WE'RE OPEN FOR OUTDOOR DINING & TAKEOUT!  Thanks,";