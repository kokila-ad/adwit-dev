var myDocument = app.documents.add();
                            // set in inches
                            myDocument.pages.everyItem().resize(CoordinateSpaces.INNER_COORDINATES,AnchorPoint.CENTER_ANCHOR,ResizeMethods.REPLACING_CURRENT_DIMENSIONS_WITH,[72*2.25,72*2.875]);
                            ...
                            var myTextFrame = myDocument.pages.item(0).textFrames.add();
                                ...
                                myTextFrame.contents = "855094 do in colour";