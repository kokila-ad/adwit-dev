var myDocument = app.documents.add();
                            // set in inches
                            myDocument.pages.everyItem().resize(CoordinateSpaces.INNER_COORDINATES,AnchorPoint.CENTER_ANCHOR,ResizeMethods.REPLACING_CURRENT_DIMENSIONS_WITH,[72*2.5555,72*3.2222]);
                            ...
                            var myTextFrame = myDocument.pages.item(0).textFrames.add();
                                ...
                                myTextFrame.contents = "test ad ignore";