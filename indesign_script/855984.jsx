var myDocument = app.documents.add();
                            // set in inches
                            myDocument.pages.everyItem().resize(CoordinateSpaces.INNER_COORDINATES,AnchorPoint.CENTER_ANCHOR,ResizeMethods.REPLACING_CURRENT_DIMENSIONS_WITH,[72*6.5556,72*12]);
                            ...
                            var myTextFrame = myDocument.pages.item(0).textFrames.add();
                                ...
                                myTextFrame.contents = 'SEE ATTACHED COPY CHANGES';