...
<div id="main">
	<section>
	<div class="container center" style="margin: 50px auto;">
	<!--<div class="container margin-top-50 margin-bottom-30"> -->
		<div class="row">
			
			<?php if(isset($pdf_file) && file_exists($pdf_file)){ ?>
			<div class="col-md-4 col-md-offset-4">
			<div class="border-0 padding-0 margin-5 small"><?php echo $this->session->flashdata('message'); ?></div>
			<div class="dropdown text-grey">
			 <form method="post">
			 <button type="submit" name="submit_form" value="approve" class="btn btn-blue btn-sm margin-top-20">Approve</button>
			 <button type="button" id="decline" class="btn btn-danger btn-sm margin-top-20">Decline</button>
			 </form>
				
						<div class="dropdown-menu file_li padding-10 margin-top-5" id="commentBox" style="z-index: 99999;">
						<div class="row margin-0" id="commentBox">
							<div id="approvalView">
							<p class="margin-bottom-5">Reason for Decline</p>
								<div class="">
									<form method="post" >
										<textarea name="decline_reason" row='3' required class="form-control"></textarea>
										<div class="text-right margin-top-10">
											<button type="submit" name="submit_form" value="decline" class="btn btn-blue padding-vertical-5 margin-right-5">Send</button>
<button type="button" name="submit_form" class="btn btn-danger padding-vertical-5" id="hide">Cancel</button>
										</div>
									</form>
								</div>
							</div>
		...
		<!--<div class="row margin-0" id="commentBox">
			<div class="col-xs-6 ">
				<form method="post" >
					...
					<textarea name="decline_reason" row='3' required></textarea>
					<button type="submit" name="submit_form" value="decline" class="btn btn-danger">Send</button>
				</form>
			</div>	
		</div>
		-->
