		...
		<div class="border-top">
			<div class="col-md-6 col-sm-6">
				...
				<div class="data">
					...
					<div class="details-data">
						<div class="row">
							<div class="col-md-8 padding-right-0"><input type="email" value="<?php if($adreps_list[0]['email_cc']!='')echo $adreps_list[0]['email_cc']; else echo" ";?>" name="email_cc" class="form-control input-sm" placeholder="Enter Email address"></div>
						</div>
					</div>
				</div>
