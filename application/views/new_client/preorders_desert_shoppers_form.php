	       ...
	       <input type="text" name="adtype" class="form-control input-sm margin-bottom-15" value="<?php echo $xml_file_data[0]['adtype']; ?>">
			...
			<div class="row margin-bottom-5">
	           <div class="col-md-7 col-sm-12 col-xs-12">
					 ...
					 <input type="number" name="width" max="99" min="1"  step="0.00001" class="form-control input-sm margin-bottom-10" value="<?php echo $xml_file_data[0]['width']; ?>" required="">
				</div>
				<div class="col-md-5 col-sm-12 col-xs-12"> 
					...
					<input type="number" name="height" max="99" min="1"  step="0.00001" class="form-control input-sm margin-bottom-10" value="<?php echo $xml_file_data[0]['height']; ?>" required="">
				</div> 
			</div>
			<?php if($xml_file_data[0]['order_type'] == 'Online'){ ?>
