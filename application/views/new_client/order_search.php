...
<p class="margin-top-10" style="text-align: center; font-weight: bold;">No New Notification</p>
						   ...
						   <div class="col-md-6 col-sm-12 col-xs-12 padding-15 padding-right-0 border-left">
							...
							<div class="row">
								<div class="col-md-8 col-sm-8 col-xs-8 padding-right-0">
								  <input type="text" name="input" class="form-control input-sm border-blue" title="" placeholder="Enter Order ID, Job ID or Advertiser Name" pattern="[0-9A-Za-z]{3}" required>
								</div>
								  ...
								  <input type="text" name="keyword" class="form-control input-sm" title="" placeholder="Enter Order ID, Job ID or Advertiser Name">
								   ...
								   <div class="row">
									  <div class="col-md-6 col-sm-6 col-xs-12 background-color-blue">
										...
										<div class="input-group date date-picker margin-bottom-15" data-date-format="dd-mm-yyyy" data-date-end-date="0d">
...
for (var i = 0; i < elements.length; i++) {
    elements[i].oninvalid = function(e) {
        ...
        if (!e.target.validity.valid) {
            e.target.setCustomValidity("3 characters / digits minimum");
        }
    };
