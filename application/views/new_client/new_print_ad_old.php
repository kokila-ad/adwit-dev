...
<!----- End of Size -->		
		...
		<?php 
			if($publication['enable_project']=='1'){ 
		...
		<div class="col-md-6 col-sm-6 col-xs-12"  ng-app="myApp" ng-controller="checkboxController">
		   <p class="margin-bottom-5 ">Select Run Date</p>
				<div class="input-group date date-picker muldate  margin-bottom-15" data-date-format="yyyy-mm-dd" data-date-start-date="+0d" >
...
<hr></hr>
	...
	<div class="row margin-bottom-5">
		...
		<div class="col-md-10 col-sm-10 col-xs-10 text-grey">
			
			<label class="cursor-pointer">
				<input id="showoptional" type="checkbox" class="margin-right-5" checked> 
				<span class="text-grey">Same As Previous</span>
			</label>
		</div>
	</div>
<hr></hr>
