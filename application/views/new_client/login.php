...
<!-- Middle Starts -->
  ...
  <?php endif;?></div>
      ...
      <input type="text" placeholder="Username" id="username" name="username" <?php if($this->input->cookie('userName')) echo "value='".$this->encryption->decrypt($this->input->cookie('userName'))."'"; ?>/><br/><br/>
