...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$(".pixel_size2").change(function(){
			$(this).find("option:selected").each(function(){
				if($(this).attr("value")=="custom"){
					$(".box2").not(".custom2").hide();
					$(".custom2").show();
					$('#custom_width2').attr('required', 'required');
					$('#custom_height2').attr('required', 'required');
				}
			   else{
				    $('#custom_width2').removeAttr('required');
					$('#custom_height2').removeAttr('required');
					$(".box2").hide();
				}
			});
		}).change();
...
<script>
		$(document).ready(function(){
				 ...
				 $("#fagreen").click(function(){
					...
					$("#pixel_size2").attr("required",true);
				 ...
				 $(".fared").click(function(){
					...
					$("#pixel_size2").attr("required",false);
...
<section>
    <div class="container margin-top-40 ">  
		...
		<div class="outborder">
			...
			<p> select Ad type</p>	  
			<a href="<?php echo base_url().index_page().'new_client/home/glacier_order_print02'; ?>" class="btn btn-sm btn-dark btn-outline margin-right-5">Print Ad</a>
			<a href="<?php echo base_url().index_page().'new_client/home/glacier_order_online02'; ?>" class="btn btn-sm btn-dark btn-outline margin-right-5 btn-active">Online Ad</a>
			...
			<span style="margin-left: 20px; padding: 0 10px;" class="font-blue"></span>
				...
				<div class="row margin-top-20 ">
					...
					<div class="col-md-3 col-sm-6 col-xs-12">
						<p class="margin-bottom-5">Size <span class="text-red">*</span>	</p>
						<div class="row margin-bottom-15">
						   <div class="col-sm-12">
								<select class="form-control input-sm pixel_size" name="pixel_size" required >
						...
						<div class="row margin-bottom-15 custom box">
						   <div class="col-md-6 col-sm-6 col-xs-6">
								 ...
								 <input type="number" name="custom_width" id="custom_width" pattern="[1-9]{1,50}" min="1" class="form-control input-sm"  value="" >
							</div>
							<div class="col-md-6 col-sm-6 col-xs-6"> 
								<p class="margin-bottom-5  ">Height<small class="text-grey">(in inches)</small><span class="text-red">*</span>
								<input type="number" name="custom_height" id="custom_height" pattern="[1-9]{1,50}" min="1" class="form-control input-sm"  value="" >
							</div>
						</div> 
					</div>
				</div>
			...
			<div id="pub_lists">
				<div class="row pub_list">
						<div id="showmpub" >
							...
							<div class="col-md-3 col-sm-6 col-xs-6 ">
								<div class="input-group date muldate date-picker margin-bottom-15" data-date-format="M d yyyy">
			...
			<!-- Required primary fields END -->
				<div class="row margin-top-20 ">
					...
					<p class="margin-bottom-5">Size <span class="text-red">*</span>	</p>
						<div class="row margin-bottom-15">
						   <div class="col-sm-12">
								<select class="form-control input-sm pixel_size2" name="pixel_size2" id="pixel_size2" >
								  <option value="">Select</option>
								  <option value="1">300 x 250(Medium Rectangle)</option>
								  <option value="2">728 x 90(Leaderboard)</option>
								  <option value="3">160 x 600(Wide Skyscraper)</option>
						...
						<div class="row margin-bottom-15 custom2 box2">
						   <div class="col-md-6 col-sm-6 col-xs-6">
								 <p class="margin-bottom-5 ">Width <small class="text-grey">(in inches)</small><span class="text-red">*</span>
								 <input type="number" name="custom_width2" id="custom_width2" pattern="[1-9]{1,50}" min="1" class="form-control input-sm"  value="" >
							</div>
							<div class="col-md-6 col-sm-6 col-xs-6"> 
								<p class="margin-bottom-5  ">Height<small class="text-grey">(in inches)</small><span class="text-red">*</span>
								<input type="number" name="custom_height2" id="custom_height2" pattern="[1-9]{1,50}" min="1" class="form-control input-sm"  value="" >
							</div>
						</div> 
					</div>
