...
<tr>
	 ...
	 Hi <?php echo $client_publication_design_team['first_name'].''.$client_publication_design_team['last_name'];?>, </p>
	</td>
</tr>
...
<tr>
 	<td>
		...
		Thank you! We have received your order. Your AdwitAds ID is <span style="color:red"><?php echo $order['id'];?></span>, Publication / Edition Name is 
...
<tr>
	 ...
	 <p style="color:#605c5c;margin:0px;padding-bottom:15px;font-size:13px;">Adwit <?php echo 'Pagination';//echo $client_publication_design_team['designTeamName'];?></p>	 
	</td>
</tr>
