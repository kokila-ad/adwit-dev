...
<div id="Middle-Div">
  <?php
	$adart_name=$this->db->get_where('art_director',array('id' => $this->session->userdata('aId')))->result_array();
	?>
    <div id="cp-div">
      <div id="cp-div-h">
      <h2>Art Director</h2>
      ...
      <table border="0">
          ...
          <tr>
            ...
            <td class="_c4"><?php echo $adart_name[0]['first_name'];?></td>
          </tr>
          <tr>
          	<th class="_c3">Gender</th>
            <td class="_c4">
			<?php
           echo $adart_name[0]['gender']==0 ? 'Female'  : 'Male' ;
			 ?>
            </td>
          </tr>
          <tr>
          	<th class="_c3">Mobile No</th>
            <td class="_c4"><?php echo $adart_name[0]['mobile_no'];?></td>
          </tr>
        </tbody>
  	  </table>
      </div>
      ...
      <table border="0">
          ...
          <tr>
            ...
            <td class="_c4"><?php echo $adart_name[0]['username'];?></td>
          </tr>
          <tr>
          	<th class="_c3">Email id</th>
            <td class="_c4"><?php echo $adart_name[0]['email_id'];?></td>
          </tr>
        </tbody>
  	  </table>
      </div>
      ...
      <div id="cp-div-l-c">
        <form id="do-change" action="<?php echo base_url().index_page()."art-director/home/dochange";?>" method="post">
        <table border="0">
      	<tbody>
        <div>
          <?php if(isset($error)): ?>
