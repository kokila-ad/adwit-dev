						...
						<div class="portlet light">
							<div class="portlet-title">
								<div class="caption" data-toggle="collapse" data-target=".todo-project-list-content">
									<span class="caption-subject font-green-sharp bold uppercase">TEAM LEAD </span>
							...
							<div class="portlet-body todo-project-list-content">
								<div class="todo-project-list">
									<ul class="nav nav-pills nav-stacked">
										<li  <?php  $active_designer = $this->db->query("SELECT * FROM `team_lead` WHERE is_active='1'")->result_array(); ?>>
											<a href="<?php echo base_url().index_page()."art-director/home/new_teams";?>"> Active <span id="lol" class="badge bg-blue"><?php echo count($active_designer); ?></span></a>
										</li>
										<li  <?php  $dactive_designer = $this->db->query("SELECT * FROM `team_lead` WHERE is_active='0'")->result_array(); ?>>
											<a href="<?php echo base_url().index_page()."art-director/home/deactive_tlead";?>"> Inactive <span id="lol" class="badge bg-blue"><?php echo count($dactive_designer); ?></span></a>
										</li>
										<li class="active">
											<a href="<?php echo base_url().index_page()."art-director/home/add_tlead";?>"> Add New </a>
										</li>
									</ul>
								</div>
							</div>
...
echo "<b style='background-color:pink;'>Submitted Successfully!</b>";
 ?>
						...
						<div class="portlet-body form">
							<form role="form" method="post" action="<?php echo base_url().index_page()."art-director/home/add_tlead";?>">
								<div class="form-body">
									<div class="form-group">
										<label>First Name</label>
										<div class="input-icon">
											<i class="fa fa-user"></i>
											<input type="text" class="form-control" placeholder="Enter Text" name="fname" required/>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="input-icon">
											<i class="fa fa-user"></i>
											<input type="text" class="form-control" placeholder="Enter Text" name="lname" required/>
										</div>
									</div>
									<div class="form-group">
