...
<!-- Middle Starts -->
  <div id="Middle-Div">  
  	...
  	<!-- Login Starts -->
    <form id="loginFrm" action="<?php echo base_url().index_page()."art-director/login/doIt";?>" method="post">    
    <div id="Login-div">    
      <div id="Login-h1">
      Login to Art Director</div>
      <div id="Login-input">
  ...
  <?php endif;?></div>
    ...
    <!-- Forgot Starts -->
     <form id="forgetFrm" action="<?php echo base_url().index_page()."art-director/login/reset";?>" method="post">
    <div id="Forgot-pass">
