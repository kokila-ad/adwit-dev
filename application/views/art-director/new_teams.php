							...
							<div class="portlet-body todo-project-list-content">
								<div class="todo-project-list">
									<ul class="nav nav-pills nav-stacked">
										<li <?php if(!isset($value)) { ?> class="active" <?php } $active_designer = $this->db->query("SELECT * FROM `team_lead` WHERE is_active='1'")->result_array(); ?>>
										...
										<li <?php if(isset($value)) { ?> class="active" <?php } $dactive_designer = $this->db->query("SELECT * FROM `team_lead` WHERE is_active='0'")->result_array(); ?>>
...
{	
	...
	?>    									
											<tr class="odd gradeX">
												...
												<td><a href="<?php echo base_url().index_page()."art-director/home/new_teams"?>/<?php echo $row['id']; ?>" class="btn btn-xs blue">View</td>
											</tr>
<?php }?>											
										</tbody>
							</table>
