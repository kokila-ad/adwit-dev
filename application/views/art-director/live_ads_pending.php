...
<script type="text/javascript">
	$(document).ready(function(e) {
        $('#channel').change(function(e) {
            window.location = "<?php echo base_url().index_page().'art-director/home/live_ads_pending_all/';?>" + $('#channel').val() ;
        });
    });
</script>
<script type="text/javascript">
	$(document).ready(function(e) {
        $('#display_type').change(function(e) {
            ...
            window.location = "<?php echo base_url().index_page().'art-director/home/live_ads';?>"
        });
    });
</script>
<script type="text/javascript">
	$(document).ready(function(e) {
        $('#publication').change(function(e) {
            window.location = "<?php echo base_url().index_page().'art-director/home/live_ads_pending_all/';?>"  + $('#channel').val()+'/'+$('#publication').val();
        });
    });
</script>
  <div id="Middle-Div">
