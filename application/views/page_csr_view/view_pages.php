...
?>
<?php $this->load->view('new_csr/header') ?>
<style>
.right{
	float: right;
}
									...
									<div class="row">
										<div class="col-md-8 col-sm-8 col-xs-8 padding-right-0">
							 			...
							 			<div class="col-md-4 col-sm-4 col-xs-4 padding-left-0">
											<a href="<?php echo base_url().index_page()."new_csr/home/index/"?>" class="text-blue right"><i class="fa fa fa-angle-double-left"></i> back</a>
										</div>
						 			</div>	
...
<?php $this->load->view('new_csr/footer') ?>
