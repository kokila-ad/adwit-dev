											...
											<tr>
												...
												<td><?php 
							   					...
							   					<td>
							   						...
							   						<form method="post" action="<?php echo base_url().index_page()."new_csr/home/page_rev_start_end/".$value['id'];?>">
							   							<button type="submit" name="start" class="btn btn-primary btn-sm">Start Revision</button>
							   						</form>
							   						<?php }elseif ($value['status']=='4') { ?>
							   							<a href="<?php echo base_url().index_page()."new_csr/home/pages_details".'/'.$value['id'];?>" class="btn btn-success btn-sm">View</a>
													<?php	
						...
						<div class="row margin-top-10">  	
							<div class=" ">  	
								<div class="col-md-6 pull-right text-right prev-next-page">
									...
									<?php if(isset($back))
									{?>
										<a href="<?php echo base_url().index_page().'new_csr/home/page_revision_design/'.$back.$key; ?>" title="Back">
											<button class="btn btn-dark btn-outline btn-sm margin-right-5"><i class="fa fa-arrow-left"></i></button>
										</a>
							 		<?php } ?>
									<?php if(isset($next))
									{ ?>
										<a href="<?php echo base_url().index_page().'new_csr/home/page_revision_design/'.$next.$key; ?>" title="Next">
