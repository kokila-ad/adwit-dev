		...
		<?php echo $this->session->flashdata('message');?> 
		    <section>
              <!--<div class="container margin-top-40 center"> 
        		 <a href="<?php echo base_url().index_page().'new_csr/home/page_index';?>" class="btn btn-sm btn-dark btn-outline">New Ads</a>
        		 <a href="<?php echo base_url().index_page().'new_csr/home/page_revision_design';?>" class="btn btn-sm btn-dark btn-outline">Revision Ads</a>
              </div>-->
              <div class="hor-menu ">
									...
									if(isset($all[0]['id'])){
										foreach ($all as $value) { ?>
											<tr>
												...
												<td>
													<a href="<?php echo base_url().index_page()."new_csr/home/pages_details".'/'.$value['id'];?>">
												...
												<td><?php 
							   					...
							   					<td style="text-align: center;">
							   						...
							   						<form method="post" action="<?php echo base_url().index_page()."new_csr/home/page_start_end/".$value['id'];?>">
							   							<button type="submit" name="start" class="btn btn-primary btn-sm">Start Design</button>
							   						</form>
							   						<?php }elseif ($value['status']=='3') {?>
							   							<a href="<?php echo base_url().index_page()."new_csr/home/pages_details".'/'.$value['id'];?>" class="btn btn-success btn-sm">
							   							    View</a>
							   					<?php	} ?>
							   					</td>
							   						...
							   						<?php if ($value['pdf']!=NULL) 
							   							{
							   								...
							   								<a target="_blank" href="<?php echo base_url().index_page()."new_csr/home/page_pdf".'/'.$pid['pd_id'];?>" data-toggle="tooltip" data-original-title="pdf">
						...
						<div class="row margin-top-10">  	
							<div class=" ">  	
								<div class="col-md-6 pull-right text-right prev-next-page">
									...
									<?php if(isset($back))
									{?>
										<a href="<?php echo base_url().index_page().'new_csr/home/page_index/'.$back.$key; ?>" title="Back">
											<button class="btn btn-dark btn-outline btn-sm margin-right-5"><i class="fa fa-arrow-left"></i></button>
										</a>
							 		<?php } ?>
									<?php if(isset($next))
									{ ?>
										<a href="<?php echo base_url().index_page().'new_csr/home/page_index/'.$next.$key; ?>" title="Next">
