...
<!-- Design -->			<?php if($designers[0]['designer_role'] == '3') { ?>
							...
							<?php if(isset($slug)){ ?>	
								...
								<button type="button" name="confirm_slug" class="btn green-jungle btn-sm" onClick="createSlug(<?php echo $row1['id']; ?>);" >Start Design</button>
							<?php }else{ ?>
								<a href="javascript:;" onclick="window.location = '<?php echo base_url().index_page().'new_designer/home/orderview/'.$form.'/'.$row1['id'];?>'" style="cursor:pointer; text-decoration: none;"><button type="button" class="btn green-jungle btn-sm">View</button></a>
							<?php } ?>
