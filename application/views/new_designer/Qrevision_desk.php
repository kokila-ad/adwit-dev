						...
						<div class="col-md-12">						
							...
							?>
								<div class="col-md-3 col-sm-4 margin-bottom-10 margin-left-10">
									<a href="<?php echo base_url().index_page().'new_designer/home/frontlinetrack_order_list/'.$type['id']; ?>" class="btn btn-success btn-block btn-lg m-icon-big row no-margin">
