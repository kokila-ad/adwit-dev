				...
				<div class="row">
					<div class="col-sm-6">
						<form action="<?php echo base_url().'index.php/new_designer/home/orderview_history/'.$hd.'/'.$order_id; ?>" method="post">
							...
							<label><input type="radio" value="yes" name="mistake" class="form-control" required>Yes</label>
							<label><input type="radio" value="no" name="mistake" class="form-control" >No</label>
