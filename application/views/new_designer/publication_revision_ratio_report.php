        				    ...
        				    <div class="row">
            					...
            					<div class="col-md-6 col-lg-6">
            					    <div class="row">
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <!--<div>
                                                <label class="btn btn-success inline version"><input type="radio" name="version" value="V1" checked <?php if(isset($_GET['version']) && $_GET['version'] == 'V1') echo 'checked'; ?>>V1-V1a</label>
                                                <label class="btn btn-success inline version"><input type="radio" name="version" value="V1a" <?php if(isset($_GET['version']) && $_GET['version'] == 'V1a') echo 'checked'; ?>>V1a-V1b</label>
                                                <label class="btn btn-success inline version"><input type="radio" name="version" value="V1b" <?php if(isset($_GET['version']) && $_GET['version'] == 'V1b') echo 'checked'; ?>>V1b-V1c</label>
                                            </div>-->
                                            <?php
                                            ...
                                            ?>
                                                ...
                                                <a href="<?php echo base_url().index_page().'new_designer/home/publication_revision_ratio_report/V1?dateRange='.$dateRange.'&from_date='.$from_date.'&to_date='.$to_date;?>" 
                                                <?php if($version == 'V1') echo 'class="btn btn-success"'; else echo 'class="btn btn-primary"'; ?>>V1-V1a</a> 
                                                <a href="<?php echo base_url().index_page().'new_designer/home/publication_revision_ratio_report/V1a?dateRange='.$dateRange.'&from_date='.$from_date.'&to_date='.$to_date;?>" 
                                                <?php if($version == 'V1a') echo 'class="btn btn-success"'; else echo 'class="btn btn-primary"'; ?>>V1a-V1b</a> 
                                                <a href="<?php echo base_url().index_page().'new_designer/home/publication_revision_ratio_report/V1b?dateRange='.$dateRange.'&from_date='.$from_date.'&to_date='.$to_date;?>" 
					...
					<table class="table table-striped table-bordered" id="sample_6">
						...
						<tbody>
						    ...
						    <tr>
						        ...
						        <td><a href="<?php echo base_url().index_page().'new_designer/home/publication_revision_ratio_report_order_list/new/'.$publicationId.'/'.$version.'/'.$from.'/'.$to; ?>" target="_blank">
						                <?php echo $new_ad_count; ?>
						            </a>
						        </td>
						        <td><a href="<?php echo base_url().index_page().'new_designer/home/publication_revision_ratio_report_order_list/revision/'.$publicationId.'/'.$version.'/'.$from.'/'.$to; ?>" target="_blank">
						            <?php echo $revision_ad_count; ?>
						            </a>
						        </td>
