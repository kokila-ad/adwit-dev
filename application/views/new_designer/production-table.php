...
<script type="text/javascript">
	...
	$(document).ready(function($) {    
   		...
   		$( "#from_date" ).datepicker({ minDate: "-10D", maxDate: -1, dateFormat: 'yy-mm-dd' });
		
		$( "#to_date" ).datepicker({ minDate: "-10D", maxDate: -1, dateFormat: 'yy-mm-dd'});
...
{	
	...
	$tot_ads=0; $tot_QA=0; $tot_NJ=0; $avg_dp=0; 
