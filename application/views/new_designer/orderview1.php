			...
			<div class="portlet-body">
				<div class="row">
					...
					<div class="col-md-6 col-sm-12">
						...
						<?php if($designer_alias[0]['designer_role'] == '2' || $designer_alias[0]['designer_role'] == '1'){?>
						<div class="portlet blue-hoki box">
							<div class="portlet-title">
						...
						<div class="col-md-4">
							<div class="row">
								...
								<div class="col-xs-4 padding-0 pull-right">
									<a class="btn btn-default btn-sm btn-block" href="<?php echo base_url()?><?php echo $map1 ;?>" target="_blank">PDF6</a>
								</div>
								<?php } ?>
								<?php //zip source
