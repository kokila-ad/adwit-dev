		...
		<div class="container margin-top-80">
			<div class="container margin-top-20">
				...
				<div class="col-md-7">
					<p>
						...
						<a href="#">Section Id:<?php echo $page_design_section['id']; ?></a>
					</p>
				</div>
			...
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					...
					<span class="dropdown margin-left-5 text-grey pull-right">
						...
						<div class="table-responsive dropdown-menu file_li">
							<table class="table table-striped table-hover" id="mytable-pdf">
							    <?php if(isset($page_section_pdf) && file_exists($page_section_pdf)){ ?>
								<tbody>
									<tr>
										<td>
										    <?php echo '<a href="'.base_url().$page_section_pdf.'" target="_blank">'.basename($page_section_pdf).'</a>'; ?>
										</td>
									</tr>
								</tbody>
								<?php } ?>
				    ...
				    <form action="<?php echo base_url().index_page()."new_designer/home/page_section_upload/".$page_design_section['id']; ?>" id="dropzonepdf" name="file" class="dropzone dz-clickable"> 
...
<script>
	   function RefreshTablePrint() { 
		   $( "#mytable-pdf" ).load( "<?php echo base_url().index_page()."new_designer/home/page_section_upload/".$page_design_section['id'];?> #mytable-pdf" );
	   }
