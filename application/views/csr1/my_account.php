									...
									<div class="portlet-body">
										<div class="tab-content">
											...
											<div class="tab-pane active" id="tab_1_1">
												<form role="form" action="<?php echo base_url().index_page()."new_csr/home/savepic";?>" Method="POST">
													<div class="form-group">
														<label class="control-label">Your Name</label>
														<input type="text" placeholder="<?php echo $csr_name[0]['name'];?>" name="csr_name"  class="form-control"/>
													</div>
													<!--<div class="form-group">
													...
													<div class="form-group">
														...
														<input type="text" placeholder="<?php echo $csr_name[0]['mobile_no'];?>" name="csr_mobile"  class="form-control"/>
													</div>
													<!--<div class="form-group">
											...
											<div class="tab-pane" id="tab_1_2">
												...
												<form action="<?php echo base_url().index_page()."new_csr/home/savepic";?>" role="form" method="POST" enctype="multipart/form-data">
													<div class="form-group">
														<div class="fileinput fileinput-new" data-provides="fileinput">
															<div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
																<img src="<?php echo base_url() ?>/images/<?php echo $csr_name[0]['image_path']; ?>">
															</div>
