                                     ...
                                     <form class="form-horizontal"  method="post">
                                      <fieldset>
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <textarea name="reason"  value="<?php echo $cat_result['reason'];?>" style="width:270px;" required></textarea>
                                          </div>
                                        </div>
                                        ...
                                        <!--<button type="submit" name="Submit" value="Submit" class="btn btn-primary">Save changes</button>-->
                                          ...
                                          <a href="javascript:;" onclick="window.location = '<?php echo base_url().index_page().'csr/home/job_status';?>'" style="cursor:pointer; text-decoration: none;"><button class="btn">Cancel</button></a>
