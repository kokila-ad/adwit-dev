...
<form name="form" method="post">
 <div id="slug-view">
	...
	if(isset($id)) 
	{	
		echo '<form name="form1" action="'.base_url().index_page().'csr/home/cp_end01" method="post" >';
		echo '<input type="text" name="oid" id="oid" value="'.$id.'" readonly style="visibility:hidden"/><br/>';
		echo '<input type="text" name="order_id" id="order_id" value="'.$order_id.'"  style="visibility:hidden"/><br/>';
