...
//Upload File
    ...
    print "<input type='submit' name='filesubmit' value='Upload'></form>";
...
?>	
   ...
   <p class="contact"><label for="name">Order No</label></p>
        <input type="text" id="order_no" name="order_no" value="<?php echo set_value('order_no');if(isset($order_num))echo $order_num; ?>" autocomplete="off">
   <p class="contact"><label for="name">Job Name</label></p>
        <input name="job_name" type="text" value="<?php echo set_value('job_name');if(isset($job_name))echo $job_name; ?>" autocomplete="off">
		
        <p class="contact"><label for="name">Width</label></p>
        <input value="<?php echo set_value('width');if(isset($width))echo $width ;?>" id="width" name="width" autocomplete="off" />
	
	<p class="contact"><label for="name">Height</label></p>
        <input onChange="fill()"  id="height" name="height" value="<?php echo set_value('height');if(isset($height))echo $height ;?>" autocomplete="off" />

	<p class="contact"><label for="name">Advertiser Name(Client Name)</label></p>
        <input name="advertiser" type="text" value="<?php echo set_value('advertiser');if(isset($advertiser))echo $advertiser ;?>" autocomplete="off">
