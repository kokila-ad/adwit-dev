...
<div id="ad-form">
      ...
      <form id="contactform">      
       ...
       <p class="contact"><label for="name">Adwit Ads ID</label></p>
        ...
        <input type="text" id="job_slug" name="job_slug"  value="<?php echo $slug;?>" readonly /> 
        
        </div>
        <div id="ad-form-s-r">
        <p class="contact"><label for="name">Notes & Instructions <span class="mandatory">*</span></label></p>
        <textarea name="copy_content_description" id="copy_content_description"  style="width: 80%; height: 80px;" ></textarea>
        <p><input name="rush" value="1" style="width:20px;" type="checkbox" ><label for="name"><span></span>Rush</label></p>
		</div>
	  ...
	  <div id="ad-form-s3">
       ...
       <p style="text-align: center;">Attach File</p>
        ...
        <div id="ad-form-s4">        
        <input class="buttom" name="submit" type="submit" value="SUBMIT" onclick="show_me(this.form.file_name)" />
        </div>
      </form>
      </div>
    </div>
