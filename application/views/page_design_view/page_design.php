		...
		<section>
		  <div class="container margin-top-40 center">                        
			...
			<?php if($adrep[0]['online_ad']=='1'){  ?>
			   <a href="<?php echo base_url().index_page().'new_client/home/new_online_ad';?>" class="btn btn-sm btn-dark btn-outline margin-right-5">Online Ad</a>
			<?php } ?>
				...
				<form method="post" name="order_form" id="order_form" >
					<div class="row">
						<div class="col-md-6 col-sm-6 col-xs-12">
						   	...
						   	<select name="publication" class="form-control input-sm margin-bottom-15" required>
						   	    <?php 
    						   	    foreach($publication_list as $publication){ 
    						   	            echo '<option value="'.$publication['id'].'">'.$publication['name'].'</option>';
    						   	    } 
						   	    ?>
						   	</select>
						...
						<div class="col-md-3 col-sm-3 col-xs-12">
						   <p class="margin-bottom-5">No. of Pages <span class="text-red">*</span></p>
