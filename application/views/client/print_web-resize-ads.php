...
<div id="ad-form">
      ...
      <div id="ad-form-p">Resize Print & Online Ad</div>
      <div id="ad-form-s">
      <form id="contactform">      
        <div id="ad-form-s-l">
        ...
        <input type="text" id="job_no" name="job_no" value="<?php echo set_value('job_no'); ?>" />
          <p class="contact"><label for="name">Resize Ad No <span class="mandatory">*</span></label></p>
...
<div id="ad-form-s6b">
  <p class="contact"><label for="name">Maximum File Size (In KBs) <span class="mandatory">*</span> </label></p>
        ...
        <div id="ad-form-s6c">
        <p class="contact"><label for="name">Online Ad Type <span class="mandatory">*</span> </label></p>
