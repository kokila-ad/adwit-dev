...
<table align="center"  border="0" cellspacing="0" cellpadding="0" style=" width: 960px; font-family:Tahoma, Geneva, sans-serif; font-size:13px; margin:0;">
    <tr>
      ...
      <td style="width:820px;"><p style="text-align: right;"><?php echo $order['created_on'];?></p></td>
    </tr>
</table>
<table width="960" border="0" cellspacing="1" cellpadding="4">
  <tr style="background-color:#333;">
    ...
    <td style="width:288px;"><p style="padding: 0px; margin: 0px; color: #FFF; font-family:Tahoma, Geneva, sans-serif; font-size:14px; text-align: center;">Pickup Print Ad</p></td>
  </tr>
  ...
  <tr style="background-color:#eee;">
    <td align="left" style="width: 288px; background-color: #eee;"><p style="padding: 10px; margin: 0px; color: #000; font-family:Tahoma, Geneva, sans-serif; font-size:14px;">Pickup Ad No</p></td>
    <td style="width: 192px;"><p style="padding: 10px; margin: 0px; color: #000; font-family:Tahoma, Geneva, sans-serif; font-size:14px;"> <?php echo $order['pickup_adno'];?></p></td>
