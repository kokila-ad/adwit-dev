...
<!-- header starts -->
  ...
  <div id="Logo">
    ...
    <ul class="dropdown clear">
	  ...
	  ?>
           <li class="sub"><a href="<?php echo base_url().index_page()."client/home/print_type";?>">Print Ad</a>
          <ul>
          	<li><a href="<?php echo base_url().index_page()."client/home/print_type/new-ads";?>">New Ad</a></li>
            <li><a href="<?php echo base_url().index_page()."client/home/print_type/pickup-ads";?>">Pickup/Template Ad</a></li>
            <li><a href="<?php echo base_url().index_page()."client/home/print_type/resize-ads";?>">Resize Ad</a></li>
          </ul>
          </li>
          <li class="sub"><a href="<?php echo base_url().index_page()."client/home/web_type";?>">Online Ad</a>
          <ul>
          	<li><a href="<?php echo base_url().index_page()."client/home/web_type/new-ads";?>">New Ad</a></li>
            <li><a href="<?php echo base_url().index_page()."client/home/web_type/pickup-ads";?>">Pickup/Template Ad</a></li>
            <li><a href="<?php echo base_url().index_page()."client/home/web_type/resize-ads";?>">Resize Ad</a></li>
          </ul>
          </li>
           
		<?php  } ?>  
        <li class="sub"><a href="<?php echo base_url().index_page()."client/home/print_web_type";?>">Print & Online Ad</a>
          <ul>
          	<li><a href="<?php echo base_url().index_page()."client/home/print_web_type/new-ads";?>">New Ad</a></li>
            <li><a href="<?php echo base_url().index_page()."client/home/print_web_type/pickup-ads";?>">Pickup/Template Ad</a></li>
            <li><a href="<?php echo base_url().index_page()."client/home/print_web_type/resize-ads";?>">Resize Ad</a></li>
          </ul>
          </li>
      ...
      <li class="divider"></li>
	   <li class="sub"><a href="#">History</a>
        <ul>
          <li><a href="<?php echo base_url().index_page()."client/home/myorders";?>">My Orders</a></li>
		  <?php if( $this->session->userdata('cId') == '171' || $this->session->userdata('cId') == '188' || $this->session->userdata('cId') == '270' ){ ?>
          <li><a href="<?php echo base_url().index_page()."client/home/publication_orders";?>">Team Orders</a></li>
		  <?php } ?>
        </ul>
      </li>
      <!--
