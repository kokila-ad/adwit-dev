...
<div class="span12">
                                     <fieldset>
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input type="text" id="order_id" name="order_id"  value="<?php echo $rev_sold['order_id'];?>" readonly />
                                          </div>
										 </div>
										 <div class="control-group">
                                          <label class="control-label" for="focusedInput">Job Slug</label>
										  <label class="control-label" for="focusedInput"><?php echo $rev_sold['order_no'];?></label>
                                        </div>
                                        <div class="control-group">
                                          <label class="control-label">Instruction</label>
                                          <div class="controls">
                                            <textarea name="instruction" style="width:270px;" readonly> <?php echo $rev_sold['note'];?> </textarea>
                                          </div>
                                        </div>
										<div class="control-group">
