...
<div id="ad-form">
      ...
      <form id="contactform">      
		...
		?>
		<!--<select class="select-style gender" name="pickup_adno" id="pickup_adno" onchange='window.location="<?php echo base_url().index_page().'client/home/web_type/pickup-ads/';?>"+ $(this).val()'>-->
		<select class="select-style gender" name="pickup_adno" id="pickup_adno" onchange='window.location="<?php echo base_url().index_page().'client/home/order_form/web/pickup-ads/';?>"+ $(this).val()' >
          <option value=''></option>
		<?php 
   ...
   <option value="custom" <?php echo set_select('pixel_size', 'custom'); ?> >Custom</option>
        ...
        <p class="contact"><label for="name">Width (in Pixels) <strong></strong></label></p>
