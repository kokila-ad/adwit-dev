...
<!-- Middle Starts -->
  ...
  <div id="Middle-Div">  
    ...
    <p style="text-align: center;"><?php echo $this->session->flashdata('message'); ?></p>
    <div id="Login-div"> 
        <div id="Login-input">
            <div id="error-div">
                <?php if(isset($error)): ?>
            ...
            <input type="text" placeholder="Email/Username" id="username" name="username" <?php if($this->input->cookie('userName')) echo "value='".$this->encryption->decrypt($this->input->cookie('userName'))."'"; ?> /><br/><br/>
        ...
        <div id="Login-button">
            ...
            <p><a id="forget" href="javascript: void(0);">Forgot  Password? Click Here</a></p>
  ...
  <div id="footer-version"><?php $footer_copy = $this->db->query("SELECT * FROM `footer_copy`")->result_array(); 
		 echo $footer_copy[0]['footer_name'];  ?></div>
