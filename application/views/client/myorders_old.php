...
<div id="Middle-Div"> <?php echo '<h4 style="color:#900;">'.$this->session->flashdata('message').'</h4>'; ?>
  ...
  <form method="post" action="<?php echo base_url().index_page().'client/home/myorders';?>" style="padding:0px; margin:0px; float: right;" >
    <span>Search: </span>
  ...
  <div class="row-fluid" style="width:96%; margin: 0 auto;"> 
    ...
    <div class="block">
      <div class="navbar navbar-inner block-header">
        <div class="muted pull-left">My Orders
			<!--<a href="javascript:;" onclick="window.location = '<?php echo base_url().index_page().'client/home/myorders';?>'" style="cursor:pointer; text-decoration: none;"><button>My Orders</button></a> 
			<a href="javascript:;" onclick="#" ><button>Proof Ready</button></a> 
			<a href="javascript:;" onclick="#" ><button>Approved</button></a> 
			<a href="javascript:;" onclick="window.location = '<?php echo base_url().index_page().'client/home/preorders';?>'" style="cursor:pointer; text-decoration: none;"><button>Booked</button></a>
		-->
		</div>
          ...
          <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
            <thead>
              <tr>
                ...
                <th style=" vertical-align:middle;">Adwit Ads ID</th>
                <th style=" vertical-align:middle;">Unique Job ID</th>
                <th style=" vertical-align:middle;">Advertiser Name</th>
                <th style=" vertical-align:middle;">Publish Date</th>
                <?php //if($publication[0]['id']=='13' || $publication[0]['id']=='43'){ ?>
...
?>
              <tr class="odd gradeX">
                ...
                <?php if($pdf_path != 'none'){ ?>
                <!-- Job Rating -->
                <td title="Job Approval"><a href="<?php echo base_url().index_page().'client/home/jRate/'.$row['id'] ;?>" onclick="javascript:void window.open('<?php echo base_url().index_page().'client/home/jRate/'.$row['id'];?>','1432728298066','width=715,height=428,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=0,left=50,top=20');return false;">
                  <button class="btn btn-success btn-mini">Approve</button>
                  </a></td>
                <!-- cancel -->
                <?php }elseif($order_status == 'Cancelled'){ echo '<td></td>';}
                ...
                <td style="cursor:pointer;"><form method="post" action="<?php echo base_url().index_page().'client/home/order_cancel/'.$row['id'];?>">
                  ...
                  <button class="btn btn-danger btn-mini" >Reject</button>
                  </a></td>
                <?php
