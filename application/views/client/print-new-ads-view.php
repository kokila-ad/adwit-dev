...
<table width="960" border="0" cellspacing="1" cellpadding="4">
  ...
  <?php $order['copy_content_description'] = str_replace(PHP_EOL,'<br/>', $order['copy_content_description']); ?>
    ...
    <tr style="background-color:#eee; vertical-align: top;">
    <td colspan="4" align="center"><p style="padding: 10px; margin: 0px; color: #000; font-family:Tahoma, Geneva, sans-serif; font-size:14px;"><?php if(isset($order['notes'])) echo htmlspecialchars($order['notes'], ENT_QUOTES, 'UTF-8');?></p></td>
    </tr>  
</table>
