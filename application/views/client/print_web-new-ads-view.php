...
<div id="content">
  ...
  <tr style="background-color:#333;">
    ...
    <td style="width:288px;"><p style="padding: 0px; margin: 0px; color: #FFF; font-family:Tahoma, Geneva, sans-serif; font-size:14px; text-align: center;">New Print & Web Ad</p></td>
  </tr>
  ...
  <tr style="background-color:#eee;">
    <td style="width: 192px;"><p style="padding: 10px; margin: 0px; color: #000; font-family:Tahoma, Geneva, sans-serif; font-size:14px;">Unique Job Name / Number<span style="color:#F00;">*</span></p></td>
  ...
  <td>&nbsp;</td>
    <td><p style="padding: 14px; margin: 0px; color: #000; font-family:Tahoma, Geneva, sans-serif; font-size:14px; text-align: center;">Files Sent Via<span style="color:#F00;">*</span></p></td>
