  ...
  <div style="padding-left: 30px; padding-top: 20px;">
     ...
     <div class="row-fluid" style="width:96%; margin: 0 auto;">
                        ...
                        <div class="navbar navbar-inner block-header">
                            <div class="muted pull-left">My Orders </div>
...
?>    									
						...
						<!-- file attach -->	<?php if($order_status == 'Order Received' || $order_status == 'Order Accepted' || $order_status == 'In Production' || ($cat_result && $cat_result[0]['question']!='none' && $cat_result[0]['answer']=='none') || ($orders_rev && $orders_rev[0]['question']!='' && $orders_rev[0]['answer']=='none')) {?>
...
<!-- Job Rating -->	
					<?php if($pdf_path != 'none'){ ?>
					<td title="Job Approval"><a href="<?php echo base_url().index_page().'client/home/jRate/'.$row['id'] ;?>" onclick="javascript:void window.open('<?php echo base_url().index_page().'client/home/jRate/'.$row['id'];?>','1432728298066','width=800,height=650,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=0,left=50,top=20');return false;"><button class="btn btn-success btn-mini">Approve</button></a></td>
<!-- cancel -->		<?php }elseif($order_status == 'Cancelled'){
					//Resubmit 
