...
<div id="ad-form-s5d">&nbsp;</div>
        ...
        <div id="ad-form-s3">
  <p class="contact"><label for="name">Copy/Content</label><br/><?php $order['copy_content_description'] = str_replace(PHP_EOL,'<br/>', $order['copy_content_description']);
																	echo $order['copy_content_description'];?></p>
