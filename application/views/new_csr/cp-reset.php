...
<!--	<input type="checkbox" name="size_check" value="size_check" required>&nbsp;&nbsp;&nbsp; Size Check <br/>
	<input type="checkbox" name="spell_check" value="spell_check" >&nbsp;&nbsp;&nbsp; Spell Check <br/>
	<input type="checkbox" name="copy_check" value="copy_check" >&nbsp;&nbsp;&nbsp; Copy Check <br/>
	<input type="checkbox" name="name_check" value="name_check" >&nbsp;&nbsp;&nbsp; Name Check <br/>
	<input type="checkbox" name="space_check" value="space_check" >&nbsp;&nbsp;&nbsp; Space Check <br/>
	<input type="checkbox" name="instruction_check" value="instruction_check" >&nbsp;&nbsp;&nbsp; Instruction Check <br/>
	<input type="checkbox" name="missing_item" value="missing_item" >&nbsp;&nbsp;&nbsp; Missing Item <br/>
	<input type="checkbox" name="flow_check" value="flow_check" >&nbsp;&nbsp;&nbsp; Flow Check <br/>
	<input type="checkbox" name="file_check" value="file_check" >&nbsp;&nbsp;&nbsp; File Check <br/>
-->
...
<div id="dp-view">
	...
	<form name="form1" action="<?php echo base_url().index_page().'csr/home/cp_end';?>" method="post" >
	...
	?>
		...
		<input type="text" name="order_id" id="order_id" value="<?php echo $pending_job['order_no']; ?>" readonly style="visibility:hidden" />
	<br/><input type="submit" name="end_time" id="end_time" value="Submit" onclick="return confirm('Are you sure you want to end the job?');" />
	</form>
