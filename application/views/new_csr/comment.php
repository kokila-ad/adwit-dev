			 ...
			 <table class="table table-striped table-bordered table-hover" >
				...
				<?php if(isset($r_review['comment'])){
					...
					<tr>
						...
						<?php if(isset($r_review['designer_id']) && $r_review['designer_id'] != '0' && $r_review['designer_reply'] != NULL ) { ?>
							<div class="row">
							<div class="col-sm-6">
							...
							<?php if(isset($r_review['tl_designer_id']) && $r_review['tl_designer_id'] != '0' && $r_review['dtl_reply'] != NULL ) { ?>
							<div class="row">
							<div class="col-sm-6">
