					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-green-sharp bold">DC Pending List</span>
							</div>
							<div class="tools">
...
<?php 
		...
		{	$form = $row['help_desk'];
			$cat_result = $this->db->get_where('cat_result',array('order_no'=>$row['id'], 'pro_status'=>'4'))->result_array();
			if($cat_result){
				$row1 = $cat_result[0];
...
<!-- date -->			<td><?php $date = strtotime($row1['timestamp']); echo date('Y-m-d', $date); ?></td>
...
<!-- QA -->            	<td title="OrderView"><a href="javascript:;" onclick="window.location ='<?php echo base_url().index_page().'new_csr/home/orderview/'.$form.'/'.$row['id'];?>'" style="cursor:pointer; text-decoration: none;"><button class="btn blue btn-xs" >view</button></a></td>     
