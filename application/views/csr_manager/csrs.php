			...
			<div class="row">
				<div class="col-md-12">
						...
						<div class="portlet light">
							<div class="portlet-title">
								<div class="caption" data-toggle="collapse" data-target=".todo-project-list-content">
									<span class="caption-subject font-green-sharp bold uppercase">CSRS </span>
							...
							<div class="portlet-body todo-project-list-content">
								<div class="todo-project-list">
									<ul class="nav nav-pills nav-stacked">
										<li <?php if(!isset($value)) echo 'class="active"';?> <?php  $active_csr = $this->db->query("SELECT * FROM `csr` WHERE is_active='1'")->result_array(); ?>>
											<a href="<?php echo base_url().index_page()."csr_manager/home/csrs";?>"> Active <span id="lol" class="badge bg-blue"><?php echo count($active_csr); ?></span></a>
										</li>
										<li <?php if(isset($value)) echo 'class="active"';?> <?php  $dactive_csr = $this->db->query("SELECT * FROM `csr` WHERE is_active='0'")->result_array(); ?>>
											<a href="<?php echo base_url().index_page()."csr_manager/home/dactive_csrs";?>"> Inactive <span id="lol" class="badge bg-blue"><?php echo count($dactive_csr); ?></span></a>
										</li>
										<li>
											<a href="<?php echo base_url().index_page()."csr_manager/home/add_new";?>"> Add New </a>
										</li>
									</ul>
								</div>
							</div>
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<span class="caption-subject font-green-sharp bold uppercase">CSR Table</span>
							</div>
							<div class="tools">
							</div>
						</div>
...
{	
	...
	?>    									
											<tr class="odd gradeX">
												...
												<td></td>
												<td><a href="<?php echo base_url().index_page()."csr_manager/home/csrs";?>/<?php echo $row['id']; ?>" class="btn btn-xs blue">View</td>
											</tr>
<?php }?>											
										</tbody>
							</table>
