...
<head>
<meta charset="utf-8"/>
<title>Csr Manager | Adwitads</title>
...
?>
<?php
	   $csr_manager=$this->db->get_where('csr_manager',array('username' => $this->session->userdata('csr_manager')))->result_array();
?>
<!-- END HEADER -->
					...
					<div class="profile-sidebar" style="width: 250px;">
						...
						<div class="portlet light profile-sidebar-portlet">
							...
							<div class="profile-userpic">
								<img src="<?php echo base_url() ?>/images/<?php echo $csr_manager[0]['image_path']; ?>" class="img-responsive" alt="">
							</div>
							<!-- END SIDEBAR USERPIC -->
							<!-- SIDEBAR USER TITLE -->
							<div class="profile-usertitle">
								<div class="profile-usertitle-name">
										<?php echo $csr_manager[0]['name'];?>
								</div>
							...
							<div class="profile-usermenu">
								<ul class="nav">
									...
									<li class="active">
										<a href="<?php echo base_url().index_page()."csr_manager/home/my_account";?>">
										<i class="icon-settings"></i>
										Account Settings </a>
									</li>
									<li>
										<a href="<?php echo base_url().index_page()."csr_manager/home/help";?>">
										<i class="icon-info"></i>
										Help </a>
									</li>
								</ul>
									...
									<div class="portlet-body">
										<div class="tab-content">
											...
											<div class="tab-pane active" id="tab_1_1">
												<form role="form" action="<?php echo base_url().index_page()."csr_manager/home/savepic";?>" Method="POST">
													<div class="form-group">
														<label class="control-label">Your Name</label>
														<input type="text" placeholder="<?php echo $csr_manager[0]['name']?>" name="name"  class="form-control"/>
														<input type="text" Hidden value="<?php echo $csr_manager[0]['id']?>" name="aid"  />
													</div>
													<!--<div class="form-group">
														<label class="control-label">Last Name</label>
														<input type="text" placeholder="<?php echo $csr_manager[0]['last_name']?>" name="last_name" class="form-control"/>
													</div>-->
													<div class="form-group">
														<label class="control-label">Mobile Number</label>
														<input type="text" placeholder="<?php echo $csr_manager[0]['mobile_no']?>" name="mobile_no"  class="form-control"/>
													</div>
													<!--<div class="form-group">
											...
											<div class="tab-pane" id="tab_1_2">
												...
												<form action="<?php echo base_url().index_page()."csr_manager/home/savepic";?>" role="form" method="POST" enctype="multipart/form-data">
													<div class="form-group">
														<div class="fileinput fileinput-new" data-provides="fileinput">
															<div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
																<img src="<?php echo base_url() ?>/images/<?php echo $csr_manager[0]['image_path']; ?>">
															</div>
											...
											<div class="tab-pane" id="tab_1_3">
											 <form id="do-change" name="do-change" onsubmit="return check();" action="<?php echo base_url().index_page()."csr_manager/home/dochange";?>" method="post">
