	...
	<div class="page-body">
		...
		<div class="lock-body">
			<div class="pull-left lock-avatar-block">
				<img src="<?php echo base_url() ?>/images/<?php echo $csr_manager[0]['image_path']; ?>" class="lock-avatar">
			</div>
			<form class="lock-form pull-left"  method="post">
				<h4><?php echo $csr_manager[0]['name'];?></h4>
				<div class="form-group">
					...
					<input type="text"  id="aid" name="aid" value="<?php echo $csr_manager[0]['id']; ?>"Hidden />
				</div>
		...
		<div class="lock-bottom">
			<a href="<?php echo base_url().index_page()?>">Not ?!<?php echo $csr_manager[0]['name'];?> </a>
		</div>
	</div>
