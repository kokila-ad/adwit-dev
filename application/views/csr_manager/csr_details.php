...
var result = result
  $.ajax({
   url: "<?php echo base_url().index_page().'csr_manager/home/active_deactive';?>",
     data: "csr_id="+csr_id+"&result="+result,
    type: "POST"
    });
	window.location = "<?php echo base_url().index_page().'csr_manager/home/csrs';?>";
}
}
</script>
</head>
					...
					<div class="profile-sidebar" style="width: 250px;">
						...
						<div class="portlet light profile-sidebar-portlet">
							...
							<div class="profile-userpic">
								<img src="<?php echo base_url() ?>/images/<?php echo $type[0]['image_path']; ?>" class="img-responsive" alt="">
							</div>
							<!-- END SIDEBAR USERPIC -->
							<!-- SIDEBAR USER TITLE -->
...
foreach($type as $row)
	 ...
	 $teams = $this->db->get_where('csr_assign',array('csr_id' => $row['id']))->result_array();
	?> 
