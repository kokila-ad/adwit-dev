...
<script>
function delete_csr(id,team_id) {
var id = id
var team_id = team_id
//alert(id);
//alert(team_id);
  ...
  $.ajax({
   url: "<?php echo base_url().index_page().'csr_manager/home/delete';?>",
     data: "id="+id+"&team_id="+team_id,
    type: "POST"
    });
	window.location = "<?php echo base_url().index_page().'csr_manager/home/teams';?>";
}
</script>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group"> 
										                       <h4>CSR</h4>
									                      <select class="form-control" name="csr">
											                     <option required="required" value="">Select</option>
                                   <?php
			                                                $type1 = $this->db->query("SELECT * FROM `csr`")->result_array();
									...
									<div id="collapse_<?php echo $row['id']; ?>_4" class="panel-collapse collapse">
										...
										<?php
										 ...
										 ?>
												...
												<td>
												     	 <a  href="<?php echo base_url().index_page()."csr_manager/home/csrs";?>/<?php echo $csr_name[0]['id']; ?>" class="label label-sm bg-blue-madison label-mini">view</a>
													 &nbsp  <a  onClick="delete_csr(<?php echo $csr_name[0]['id']; ?>,<?php echo $row['id'];?>);" class="label label-sm bg-blue-madison label-mini">Remove</a>
