						...
						<div class="portlet light">
							<div class="portlet-title">
								<div class="caption" data-toggle="collapse" data-target=".todo-project-list-content">
									<span class="caption-subject font-green-sharp bold uppercase">CSR</span>
							...
							<div class="portlet-body todo-project-list-content">
								<div class="todo-project-list">
									<ul class="nav nav-pills nav-stacked">
										<li  <?php  $active_csr = $this->db->query("SELECT * FROM `csr` WHERE is_active='1'")->result_array(); ?>>
										...
										<li  <?php  $dactive_csr = $this->db->query("SELECT * FROM `csr` WHERE is_active='0'")->result_array(); ?>>
					...
					<div class="portlet light">
                     ...
                     echo "<b style='background-color:pink;'>Submitted Successfully!</b>";
						...
						<div class="portlet-body form">
							<form role="form" method="post" action="<?php echo base_url().index_page()."csr_manager/home/add_csr";?>">
								<div class="form-body">
