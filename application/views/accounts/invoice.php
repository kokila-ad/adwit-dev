					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								...
								<?php echo $group_list[0]['name'];?>/
								<?php echo $publication_name[0]['name'];?>/
								
								<small class="font-green"> <?php echo $invoice_no;?>/<?php echo $inv_inc;?></small></span>
							</div>	
                             <div class="tools">
						...
						<div class="portlet-body">
							<table class="table table-scrollable table-striped table-hover" id="testTable">
							<thead>
							<tr>
 					   ...
 					   <div class="row margin-top-15">
							<div class="col-md-6">
								<form action="<?php echo base_url().index_page().'accounts/home/invoice_to_customers/'.$publication_name[0]['id'].'/'.$invoice_details[0]['date'];?>" method="post">
								<p> <strong>Bill To:</strong> <?php echo $publication_name[0]['name']; ?> </p>
								<p> <strong>Invoice#</strong>  <?php echo $invoice_no;?>/<?php echo $inv_inc;?> </p>
								...
								<?php } ?>
									<!--<a href="<?php echo base_url().index_page().'accounts/home/invoice_to_customers/'.$publication_name[0]['id'].'/'.$invoice_details[0]['date'];?>" class="btn green">Send to Customer</a>
								--><button name="bill" class="btn green" type="submit" value="Send to Customer">Send to Customer</button>
								</form>
								<a href="<?php echo base_url().index_page().'accounts/home/new_invoice_pdf/'.$inv_id?>" class="btn btn-info">PDF Report</a>
