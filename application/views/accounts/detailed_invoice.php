					...
					<div class="portlet light">
						<div class="portlet-title">
							...
							<span class="caption-subject grey-gallery bold ">
								...
								<?php $publication_id=$this->db->get_where('publications',array('id'=>$orders[0]['publication_id']))->result_array();
										echo $publication_id[0]['name'] ?>/
								<?php echo date('M-Y', strtotime($orders[0]['created_on'])); ?>
							</span>
							</div>	
						...
						<div class="portlet-body ">
							...
							<?php }?>	
							<tfoot class="portlet solid grey-silver">
							<tr>
								<th></th>
								<th></th>
								<th></th>
