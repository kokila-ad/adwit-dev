					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-green-sharp bold uppercase">Invoice</span>
							</div>
							<div class="tools">
						...
						<div class="portlet-body">
									...
									<h1></h1>
										<div class="btn-group pull-right">
											...
											<ul class="dropdown-menu pull-right">
												...
												<li>
													<button onclick="tableToExcel('testTable', 'W3c Example Table')">
							...
							<?php 
								$inv_amount = '0'; $total_sqinches='0'; $inv_id='0'; 
							...
							<tr>
								...
								<td>
									...
									<?php $w=$row['width'];
										  ...
										  $inv_amount = $inv_amount + $rate;
										  
								
									?>
								<td>
									<a href= "<?php echo base_url().index_page().'accounts/home/edit_orders'.'/'.$customer['id'].'/'.$publication_name[0]['id'].'/'.$row['id'];?>">Edit</a>
						...
						<form action="<?php echo base_url().index_page().'accounts/home/updated_invoice_details/'.$customer['id'].'/'.$publication_name[0]['id'].'/'.$inv_id.'/'.$total_sqinches.'/'.$inv_amount;?>" method="post">
						
						<input class="btn btn-circle green" name="update_bill" type="submit"  value="Update Bill" style="width:20%">
						</form>
