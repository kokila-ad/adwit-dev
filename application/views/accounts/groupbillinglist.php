								...
								<div class="portlet light ">
								   <div class="portlet-title tabbable-line">
								    ...
								    <div class="clearfix">
										...
										?>
										<a href="<?php echo base_url().index_page().'accounts/home/publication_list/'.$type['group_id'];?>" >
										<button name="group" class="btn default btn-block"><?php echo $group[0]['name'];?></button>
										</a>
										</br>
										<?php } ?>
