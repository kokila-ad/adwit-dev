					...
					<div class="portlet light">
						...
						<div class="portlet-body">
							...
							<?php 
								...
								{
									$inv_id = $row['inv_id'];
									$details = $this->db->query("SELECT * FROM `invoice` WHERE `id`=$inv_id;")->result_array();
							...
							<tr>
								...
								<td><?php echo $data['invoice_no']; ?>/<?php echo $data['invoice_no1']; ?></td>
								<td><?php $publication_id=$this->db->get_where('publications',array('id'=>$data['publication_id']))->result_array();		
								echo $publication_id[0]['name']; ?></td>
								
								
								<td>	
								<a href= "<?php echo base_url().index_page().'accounts/home/received_inv_view/'.$data['id'];?>">View</a>
									</td>
