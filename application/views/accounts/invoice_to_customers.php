						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="portlet light ">
								  <div class="portlet-body text-center margin-top-20 margin-bottom-30 ">
								    ...
								    <p> <strong>Attn:</strong> <?php $adrep=$this->db->get_where('adreps',array('id'=>$publication_name[0]['customer_id']))->result_array();		
										echo $adrep[0]['first_name'].$adrep[0]['last_name'] ?> </p>
								 </p>		
                                    <p class="margin-top-20">Bill sent successfully! please check your <span class="font-green">payment received </span> tab to view status of this bill</p>
