				...
				<div class="col-lg-12">
					<div class="navbar navbar-default" role="navigation">
								<div class="collapse navbar-collapse navbar-ex1-collapse">
									<form class="navbar-form navbar-left" action="http://localhost/weborders/index.php/accounts/home/orders" role="search" method="post">
										...
										<button type="submit"  name="search" value="Submit" class="btn blue">Search</button> 
									</form>		
									<ul class="nav navbar-nav navbar-right">
										<li class="dropdown">
											...
											<?php $types = $this->db->get_where('publications')->result_array(); foreach($types as $type) { ?>
												<li>
													<a href="<?php echo base_url().index_page().'accounts/home/helpdesk_joblist';?>/<?php echo $type['id'];?>">
					...
					<table class="table table-striped table-bordered table-hover" id="sample_1">
						...
						<tbody>
							...
							<tr>
								...
								<td>	
									 <?php $publication_name=$this->db->get_where('publications',array('id'=>$row['publication_id']))->result_array();
										echo $publication_name[0]['name'] ?>
								</td>
								<td>
