					...
					<div class="portlet light">
						...
						<div class="portlet-body">
							...
							<tr>
								...
								<td><?php echo $row['special_discount']; ?></td>
							</tr>  
							<tr>
								<td></td>
								<td></td>
								...
								<td><strong><?php echo $row['sub_total']; ?></strong></td>
							</tr> 
							<tr>
								<td></td>
								<td></td>
							...
							<tr>
								...
								<td><strong><?php echo $row['total_due']; ?></strong></td>
							</tr>
							</tbody>
							</table>             										 
					 </div>	
 					   <div class="row margin-top-15">
								...
								$adrep=$this->db->get_where('adreps',array('id'=>$publication_id[0]['customer_id']))->result_array();		
										echo $adrep[0]['first_name'] ?> </p>
								<?php } ?>
									
									<a href="<?php echo base_url().index_page().'accounts/home/invoice_to_customers/'.$publication_name[0]['id'].'/'.$invoice_no.'/'.$inv_inc;?>" class="btn green">Send to Customer</a>
								</div>
								<div class="col-md-6 text-right">	
									<button type="button" class="btn blue-hoki">Download Invoice</button>
									<button type="button" class="btn blue-chambray">View Detailed Bill</button>
								</div>
							</div>
					</div>
				</div>
