								...
								<div class="portlet light ">
								   <div class="portlet-title tabbable-line">
									...
									<div class="portlet-title tabbable-line">
										<div class="caption caption-md">
											<i class="icon-globe theme-font hide"></i>
											<span class="caption-subject font-grey-gallery bold ">List Of Group</span>
										</div>
									</div>
								
								    <div class="portlet-body text-center margin-bottom-25 ">
										<div class="clearfix">
											<?php foreach($group_list as $type) {  
												$group = $this->db->get_where('Group',array('id'=>$type['group_id']))->result_array(); 
											?>
											<a href="<?php echo base_url().index_page().'accounts/home/invoice_creation/'.$type['group_id'];?>" >
											<button name="group_id" class="btn default btn-block"><?php echo $group[0]['name'];?></button>
											</a>
											</br>	
											<?php } ?>
										</div>	
									...
									<?php } elseif(isset($publication_list)){
									$group = $this->db->get_where('group',array('id'=>$group_id))->result_array(); 
									?>
									
									 <div class="portlet-title tabbable-line">
										<div class="caption caption-md">
											<span class="caption-subject font-grey-gallery bold "><?php echo $group[0]['name']; ?> </span>
										</div>
									</div>	
									...
									<div class="portlet-body text-center margin-bottom-25 ">
										<div class="clearfix">
											...
											<form action="<?php echo base_url().index_page().'accounts/home/invoice_creation'.'/'.$group_id.'/'.$type['id'];?>" method="post">
