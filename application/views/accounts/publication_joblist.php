		...
		<div class="container">
					...
					<div class="portlet light">
						...
						<div class="portlet-body">
							...
							<?php 
								...
								foreach($publication_name as $row)
								{
							...
							<tr>
								...
								<td>
									...
									?>
									<a href="<?php echo base_url().$row['pdf'];?>" target="_blank">View</a>
									<?php } ?>
								</td>
							</tr>
							<?php } ?>
			...
			<div id="ad-form-s4">   
				<div class="form-actions">
					<?php if(isset($date)){ ?>
					<form action="<?php echo base_url().index_page().'accounts/home/bill/'.$customer['id'].'/'.$publication_n[0]['id'];?>" method="post">
						<input type="text" name="date" value="<?php echo $date; ?>" style="display:none;">
						<input class="btn btn-circle green" name="generate_bill" type="submit"  value="Generate Bill" style="width:20%">
					</form>
					<?php } ?>
