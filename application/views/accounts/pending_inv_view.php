...
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>ui_assets/global/plugins/clockface/css/clockface.css"/>
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>ui_assets/global/plugins/bootstrap-datepicker/css/datepicker3.css"/>
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>ui_assets/global/plugins/bootstrap-timepicker/css/bootstrap-timepicker.min.css"/>
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>ui_assets/global/plugins/bootstrap-colorpicker/css/colorpicker.css"/>
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>ui_assets/global/plugins/bootstrap-daterangepicker/daterangepicker-bs3.css"/>
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>ui_assets/global/plugins/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css"/>
				...
				<div class="col-md-12">
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<span class="caption-subject grey-gallery bold ">
								<?php $group_id=$this->db->get_where('Group',array('id'=>$invoice_details[0]['customer_id']))->result_array();
								echo $group_id[0]['name']; ?>/
								<?php $publication_id=$this->db->get_where('publications',array('id'=>$invoice_details[0]['publication_id']))->result_array();
								echo $publication_id[0]['name']; ?>/
								
								<small class="font-green"> <?php echo $invoice_details[0]['invoice_no'];?>/<?php echo $invoice_details[0]['invoice_no1'];?></small></span>
							</div>	
                             <div class="tools">
								 <span class="grey-gallery"><?php echo date("Y-m-d");?></span>
							</div>							
						</div>
						<div class="portlet-body">
							...
							<tr>
								...
								<td><?php echo $row['total_sq_inches']; ?></td>
								<td><?php $price = $this->db->get_where('price_per_sq_inches',array('publication_id'=>$invoice_details[0]['publication_id']))->result_array();
							...
							<tr>
								...
								<td><strong><?php echo round($row['sub_total'],2); ?></strong></td>
							</tr> 
							<tr>
								<td></td>
								<td></td>
							...
							<tr>
								...
								<td><strong><?php echo round($row['total_due'],2); ?></strong></td>
							</tr>
							</tbody>
							</table>             										 
					 </div>	
 					   <div class="row margin-top-15">
							<div class="col-md-6">
								<p> <strong>Bill To:</strong> <?php echo $publication_id[0]['name']; ?> </p>
								<p> <strong>Invoice#</strong>  <?php echo $invoice_details[0]['invoice_no'];?>/<?php echo $invoice_details[0]['invoice_no1'];?> </p>
								<p> <strong>Attn:</strong> 
								<?php 
								
								$publication_id=$this->db->get_where('publications',array('id'=>$row['publication_id']))->result_array();
								$adrep=$this->db->get_where('adreps',array('id'=>$publication_id[0]['customer_id']))->result_array();		
										echo $adrep[0]['first_name'].$adrep[0]['last_name']; ?> </p>
								
								<?php } ?>
								<form action="" method="post">
									<input name="payment_received" class="btn green" type="submit" value="Payment Received">
								</form>
								<a href= "<?php echo base_url().index_page().'accounts/home/billing_homepage';?>" class="btn blue-chambray">Billing Home Page</a>
							</div>
...
<script type="text/javascript" src="<?php echo base_url(); ?>ui_assets/global/plugins/bootstrap-timepicker/js/bootstrap-timepicker.min.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>ui_assets/global/plugins/clockface/js/clockface.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>ui_assets/global/plugins/bootstrap-daterangepicker/moment.min.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>ui_assets/global/plugins/bootstrap-daterangepicker/daterangepicker.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>ui_assets/global/plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>ui_assets/global/plugins/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js"></script>
...
<script src="<?php echo base_url(); ?>ui_assets/admin/pages/scripts/components-pickers.js"></script>
...
<script>
        ...
        if (!table.nodeType) table = document.getElementByName(table)
