	...
	<div class="portlet-body">		
		<div class="row">
			...
			<!---Verify Report starts--->
				...
				<form method="GET" action="<?php echo base_url().index_page().'new_admin/home/size_report/'.$type.'/custom';?>">
					<div class="row " >
...
$('#custom_date').change(function() {
		if($('#custom_date').val() != 'custom'){
			window.location = "<?php echo base_url().index_page().'new_admin/home/size_report/'.$type.'/';?>" + $('#custom_date').val() ;
		}
	});
</script>
