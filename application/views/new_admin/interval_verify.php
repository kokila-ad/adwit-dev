...
<div class="portlet light">
	<div class="portlet-body">		
		<div class="row">
			...
			<div class="col-md-2 col-sm-6 margin-bottom-20 <?php if($type == 'customer') echo 'active'; ?>">
				<a href="<?php echo base_url().index_page().'new_admin/home/customer_instruction/customer' ?>"><div class="option-theme5">Customer Instruction</div></a>
			</div>
			<div class="col-md-2 col-sm-6 margin-bottom-20 <?php if($type == 'designer_interval') echo 'active'; ?>">
				<a href="<?php echo base_url().index_page().'new_admin/home/admin_report_designer_interval/designer_interval/designer' ?>"><div class="option-theme5">Designer Interval Report</div></a>
			</div> 
			<div class="col-md-2 col-sm-6 margin-bottom-20 <?php if($type == 'interval') echo 'active'; ?>">
				<a href="<?php echo base_url().index_page().'new_admin/home/admin_report_production/interval' ?>"><div class="option-theme5">Master Report</div></a>
			</div> 
		</div>
...
<!----------Publication count report Ends------------->		
			...
			<!---Designer Report starts--->
				...
				<form method="GET" action="<?php echo base_url().index_page().'new_admin/home/admin_report_designer_avg_nj/'.$type.'/'.$user;?>">
			...
			<?php if((isset($type)) && ($type == 'category')) { ?>
				<div class="form-group has-success">
					<select id="user_id" name="user_id" class="select2me form-control">
						<option value="">Select</option>
						<option value="publications" <?php if($user=='publications') echo 'selected';?>>Publication</option>
						
					</select>
				</div>
			<!---Publication Report starts--->
				<?php if(isset($publications)) { ?>
				<form method="GET" action="<?php echo base_url().index_page().'new_admin/home/admin_report_category/'.$type.'/'.$user;?>">
				<select id="publication_id" name="publication_id" class="select2me form-control margin-bottom-10 border-radius-5">
						<option value="">Select</option>
						<option value="all" <?php if($id=='all') echo 'selected';?>>All</option>
						<?php foreach($publications as $row) { ?>
			...
			<!--------Publication Revision Starts-------->
			<?php if((isset($type)) && ($type == 'revision')) { ?>
				<div class="form-group has-success">
					<select id="user_id" name="user_id" class="select2me form-control">
						<option value="">Select</option>
						<option value="publications" <?php if($user=='publications') echo 'selected';?>>Publication</option>
			...
			<!---Publication Report starts--->
				<?php if(isset($publications)) { ?>
				<form method="GET" action="<?php echo base_url().index_page().'new_admin/home/revision_instruction/'.$type.'/'.$user;?>">
				<select id="publication_id" name="publication_id" class="select2me form-control margin-bottom-10 border-radius-5">
						<option value="">Select</option>
						<option value="all" <?php if($id=='all') echo 'selected';?>>All</option>
						<?php foreach($publications as $row) { ?>
			...
			<!--------Publication Revision Ends------------->
			
			<!--------Publication Customer Starts-------->
			...
			<!---Publication Report starts--->
				<?php if(isset($publications)) { ?>
				<form method="GET" action="<?php echo base_url().index_page().'new_admin/home/customer_instruction/'.$type.'/'.$user;?>">
				<select id="publication_id" name="publication_id" class="select2me form-control margin-bottom-10 border-radius-5">
						<option value="">Select</option>
						<option value="all" <?php if($id=='all') echo 'selected';?>>All</option>
						<?php foreach($publications as $row) { ?>
			...
			<!---Verify Report starts--->
				...
				<form method="GET" action="<?php echo base_url().index_page().'new_admin/home/revision_verify_report/'.$type.'/custom';?>">
					<div class="row " >
			...
			<!--------Interval Starts-------->
			<?php if((isset($type)) && ($type == 'interval')) { ?>
				<div class="form-group has-success"></div>
			<!---Verify Report starts--->
				
					<div class="row">
					<div class="col-md-12 col-md-offset-1" >
					 <select id="c_date" class="colorselector form-control " name="c_date">
				   <option value="">Select</option>
					<option value="today" <?php if($date=='today') echo 'selected';?>>Today</option>
					<option value="last_week" <?php if($date=='last_week') echo 'selected';?> >Last Week</option>
					<option value="last_month" <?php if($date=='last_month') echo 'selected';?>>Last Month</option>
				...
				<form method="GET" action="<?php echo base_url().index_page().'new_admin/home/interval_verify_report/'.$type.'/custom';?>">
					<div class="row " >
                        <div class="col-md-12 col-md-offset-1 colors margin-top-15" id="custom" style="display:none">
					  <div  class="input-group  date-picker input-daterange margin-bottom-15  " data-date="2012/11/10" data-date-format="yyyy-mm-dd" data-date-end-date="+0d">
						<!--<input type="text" name="order_type" value="2" style="display:none">-->
...
$('#c_date').change(function() {
		if($('#c_date').val() != 'custom'){
			window.location = "<?php echo base_url().index_page().'new_admin/home/interval_verify_report/'.$type.'/';?>" + $('#c_date').val() ;
		}
	});
</script>
