...
<div class="portlet light">
	<div class="portlet-body">
		<div class="row">
			...
			<div class="col-md-2 col-sm-6 margin-bottom-20">
				<a href="<?php echo base_url().index_page().'new_admin/home/hourly_production_report' ?>"><div class="option-theme5">Hourly Production</div></a>
			</div>
			<div class="col-md-2 col-sm-6 margin-bottom-20">
				<a href="<?php echo base_url().index_page().'new_admin/home/hourly_production_report_category' ?>"><div class="option-theme5">Hourly Production Category</div></a>
			</div>
			<div class="col-md-2 col-sm-6 margin-bottom-20">
				<a href="<?php echo base_url().index_page().'new_admin/home/hourly_order_count_graph' ?>"><div class="option-theme5">Hourly Order Count Graph</div></a>
			</div>
		</div>		
		<div class="row">
			<div class="col-md-2 col-sm-6 margin-bottom-20">
		...
		<div class="row">
			...
			<div class="col-md-2 col-sm-6 margin-bottom-20 ">
				<a href="<?php echo base_url().index_page().'new_admin/home/adwit_team_report' ?>"><div class="option-theme5"> Team Wise Report </div></a>
			</div>
		</div>	
