						...
						<div class="dropdown-menu hold-on-click dropdown-checkboxes" role="menu">
							...
							<div class="row margin-top-10">
								<div class="col-md-6 col-sm-12 margin-bottom-5">
									...
									<select class="form-control input-sm" name="club" >
									<option value="">Select</option>
											<?php foreach($club as $club_row){ ?>
										<option value = "<?php echo $club_row['id'];?>" ><?php echo($club_row['name']);?></option>
											<?php }?>	
									</select>
								</div>	
							</div>
...
<div class="row ">	
    <div class="col-md-6 col-sm-6 margin-bottom-20">
		<a href="<?php echo base_url().index_page().'new_admin/home/lite_dashboard' ?>"><div class="option-theme1">Lite</div></a>
	</div>
</div>	
</div>	
<!-- End lite -->
