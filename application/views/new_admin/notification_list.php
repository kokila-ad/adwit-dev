				...
				<!-- BEGIN EXAMPLE TABLE PORTLET-->
						<div class="portlet box grey-gallery">
							<div class="portlet-title">
								<div class="caption">
									<a href="<?php echo base_url().index_page()."new_admin/home/notification_add";?>" class="btn default btn-xs">
										<i class="fa fa-plus margin-right-10"></i>Add Notification 1
									</a>
									<a href="<?php echo base_url().index_page()."new_admin/home/notification_new";?>" class="btn default btn-xs">
							...
							<div class="portlet-body">
								...
								<tbody>
									...
									<tr>
										...
										<?php } ?>
										<td>
											<a href="<?php echo base_url().index_page().'new_admin/home/notification_edit/'.$row['id'];?>" class="font-blue margin-right-10"><i class="fa fa-edit"></i></a>
										</td>
									</tr>								
									<?php } ?>
								</tbody>
