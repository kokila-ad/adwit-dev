...
<div class="page-container">
	<div class="page-content">
		<div class="container">
		        ...
		        <div class="col-md-12 value text-right">	
						...
						<div class="note note-danger margin-bottom-5">
							<div class="row">
								<div class="col-sm-6">
									...
									<?php if($Qrow['answer']==''){  ?>
										<div id="ans">
										<form  method="POST" action="<?php echo base_url().index_page().'new_admin/home/frontline_answer/'.$rev_row['id'];?>" role="form" enctype="multipart/form-data">
