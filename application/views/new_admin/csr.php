...
<div class="portlet light">
	...
	<input type="text" id="csv_tab_name" value="csr.csv" style="display:none">
		<table class="table table-bordered table-hover" id="sample_6">
			<thead>
				<tr>
					<th>CSR Name - <span class="badge"><?php echo count($csr);?></th>
					<th>Username</th>
					<th>Location</th>
				</tr>
			</thead>
			...
			<?php foreach($csr as $row){
				...
				?>
				<tr>
					<td><a href="<?php echo base_url().index_page().'new_admin/home/csr_profile/'.$row['id']; ?>"> <?php echo $row['name'] ;?></a></td>
					<td><?php echo $row['username']; ?></td>
					<td><?php if($row['Join_location']=='0' || $row['Join_location']==''){ echo ""; }else { echo $location_name[0]['name']; }?></td>				</tr>
