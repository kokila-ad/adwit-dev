...
<div class="portlet light">
	<div class="portlet-body">		
		<div class="row">
			...
			<div class="col-md-2 col-sm-6 margin-bottom-20 <?php if($type == 'designer_nj') echo 'active'; ?>">
				<a href="<?php echo base_url().index_page().'new_admin/home/designer_nj' ?>"><div class="option-theme5">New Production Report</div></a>
			</div> 
			
			<div class="col-md-2 col-sm-6 margin-bottom-20 <?php if($type == 'back_to_designer') echo 'active'; ?>">
				<a href="<?php echo base_url().index_page().'new_admin/home/back_to_designer' ?>"><div class="option-theme5">Back to Designer Stats</div></a>
			</div> 
		</div>
...
<!----------Publication count report Ends------------->		
			...
			<?php if(isset($team_lead)) { ?>
				<form method="GET" action="<?php echo base_url().index_page().'new_admin/home/report_tl_interval/'.$type.'/'.$user;?>">
				<div class="row">
					<div class="col-md-12 col-md-offset-1" >
