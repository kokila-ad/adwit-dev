	...
	<div class="portlet-body">		
		<div class="row">
			<div class="col-md-2 col-sm-6 margin-bottom-20 <?php if($type == 'production') echo 'active'; ?>">
				<a href="<?php echo base_url().index_page().'new_admin/home/admin_report_production/production'?>" ><div class="option-theme5">Production</div></a>
			</div>	
		...
		<!--	<div class="col-md-2 col-sm-6 margin-bottom-20 <?php if($type == 'designer_instruction') echo 'active'; ?>">
				<a href="<?php echo base_url().index_page().'new_admin/home/admin_report_production/designer_instruction/designer' ?>"><div class="option-theme5">Designer Instruction</div></a>
			</div> -->
