...
<div class="portlet light">
	<div class="portlet-title">
		<div class="row">	
			<div class="col-md-7 col-xs-12">
				<span class="font-lg">Sent Helpdesk Status</span> 
			</div>				
	...
	<div class="portlet-body">
		...
		<?php if(isset($sent_dbyst_all_orders)){?>
		<?php	foreach($sent_dbyst_all_orders as $row){
		...
		<?php if(isset($sent_dbyyst_all_orders)){?>
			<?php foreach($sent_dbyyst_all_orders as $row){
					$adrep_name = $this->db->get_where('adreps',array('id' => $row['adrep_id']))->result_array();
					$publication_name = $this->db->get_where('publications',array('id'=> $row['publication_id']))->result_array();
					?>
			<tr>
		...
		<?php if(isset($sent_all_orders)){?>
			<?php foreach($sent_all_orders as $row){
					$adrep_name = $this->db->get_where('adreps',array('id' => $row['adrep_id']))->result_array();
					$publication_name = $this->db->get_where('publications',array('id'=> $row['publication_id']))->result_array();
					?>
