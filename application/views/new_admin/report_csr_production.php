...
<script>
 $(document).ready(function(){
	...
	window.location = "<?php echo base_url().index_page().'new_admin/home/report_csr_production/'.$type.'/';?>" + $('#user_id').val() ;
	});
	
	
	$('#csr_id').change(function() {
	window.location = "<?php echo base_url().index_page().'new_admin/home/report_csr_production/'.$type.'/'.$user.'/';?>" + $('#csr_id').val() ;
	});
