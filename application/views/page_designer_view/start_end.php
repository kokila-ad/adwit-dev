		...
		<div class="container margin-top-80">
			...
			<div class="row">
				<div class="col-md-6 col-sm-6 col-xs-12">
				    ...
				    <form action="<?php echo base_url().index_page()."new_designer/home/page_zip_upload/".$pass_id['id']; ?>" name="file" class="dropzone  dz-clickable"> 
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
				    ...
				    <form action="<?php echo base_url().index_page()."new_designer/home/page_pdf_upload/".$pass_id['id']; ?>" name="file" class="dropzone  dz-clickable"> 
				    	<div class="dz-default dz-message">
				    		<span>
				    			<strong>
				    				Drag files
				...
				<div class=" col-md-12 margin-top-15 text-right">
					<form method="post" action="<?php echo base_url().index_page()."new_designer/home/page_end/".$pass_id['id']; ?>">
...
<script>
	   function RefreshTablePrint() { 
		   $( "#mytable-zip" ).load( "<?php echo base_url().index_page()."new_designer/home/page_start_end/".$pass_id['id'];?> #mytable-zip" );
		   $( "#mytable-pdf" ).load( "<?php echo base_url().index_page()."new_designer/home/page_start_end/".$pass_id['id'];?> #mytable-pdf" );
	   }
