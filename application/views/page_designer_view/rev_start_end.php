		...
		<div class="container margin-top-20">
			...
			<div class="row">
				<div class="col-md-12 margin-top-20">
					<div class="">
						<form method="post" action="<?php echo base_url().index_page().'new_designer/home/page_source/'.$all['pd_id']?>">
			...
			<div class="row">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
			    	...
			    	<form action="<?php echo base_url().index_page()."new_designer/home/page_rev_zip_upload/".$all['id'].'/'.$all['pd_id'];?>" name="file" class="dropzone  dz-clickable"> 
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
			    	...
			    	<form action="<?php echo base_url().index_page()."new_designer/home/page_rev_pdf_upload/".$all['id'].'/'.$all['pd_id'];?>" name="file" class="dropzone  dz-clickable"> 
			    		<div class="dz-default dz-message">
			    			<span>
			    				<strong>
			    					Drag files
				...
				<div class=" col-md-12 margin-top-15 text-right">
					<form method="post" action="<?php echo base_url().index_page()."new_designer/home/page_rev_end/".$all['id']; ?>">
...
<script>
	   function RefreshTablePrint() { 
		   $( "#mytable-zip" ).load( "<?php echo base_url().index_page()."new_designer/home/page_rev_start_end/".$all['id'];?> #mytable-zip" );
		   $( "#mytable-pdf" ).load( "<?php echo base_url().index_page()."new_designer/home/page_rev_start_end/".$all['id'];?> #mytable-pdf" );
	   }
