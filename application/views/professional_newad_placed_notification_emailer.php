...
<tr>
 	<td>
		...
		Thank you! We have received your order. Your AdwitAds ID is <span style="color:red"><?php echo $order['id'];?></span> &amp; Unique Job Name / Number is 
			<span style="color:red"><?php echo $order['job_no'];?></span>
		</p>
	</td>
</tr>
...
<tr>
 	<td>
		<p style="margin:40px 0 30px 0;">
			<a href="<?php echo base_url().index_page().'professional_edition/home/dashboard';?>" style="text-decoration:none;font-size:14px;background:#30a6c6;padding:8px 30px;border-radius:3px;color:white;outline:none;border:none;cursor:pointer;" >
