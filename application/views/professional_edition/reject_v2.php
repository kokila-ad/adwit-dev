...
<div class="span12">
									...
									<?php } } } ?>	 
                                        ...
                                        <div style="padding-left: 180px;">
                                         ...
                                         <a href="javascript:;" onclick="window.location = '<?php echo base_url().index_page().'professional_edition/home/dashboard';?>'" style="cursor:pointer; text-decoration: none;"><button class="btn">Go Back</button></a>
                                        </div>
                                      </fieldset>
                                    </form>
