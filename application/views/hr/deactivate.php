		...
		<div class="container">
			...
			<div class="hor-menu ">
				<ul class="nav navbar-nav" >
					...
					<li>
						<a href="<?php echo base_url().index_page()."hr/home/employees";?>">EMPLOYEES</a>
					</li>
					<li>
						<a href="<?php echo base_url().index_page()."hr/home/add_employee";?>">ADD EMPLOYEES</a>
					</li>
				</ul>
			</div>
			<!-- END MEGA MENU -->
...
<div id="ad-form">
      ...
      <div id="ad-form-s4"> 
		...
		<a href= "<?php echo base_url().index_page().'hr/home/employees';?>"><input class="buttom" id="button" type="button" name="button" value="CANCEL" style="width:20%"></a>
       </div>
</div>
</div>
</div>	   
