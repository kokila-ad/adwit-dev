...
<!-- Middle Starts -->
  <div id="Middle-Div">  
  	...
  	<!-- Login Starts -->
    <form id="loginFrm" action="<?php echo base_url().index_page()."management/login/doIt";?>" method="post">    
    <div id="Login-div">    
      <div id="Login-h1">
     Management Login </div>
      <div id="Login-input">
  ...
  <?php endif;?></div>
    ...
    <!-- Forgot Starts -->
     <form id="forgetFrm" action="<?php echo base_url().index_page()."management/login/reset";?>" method="post">
    <div id="Forgot-pass">
