...
<!-- Middle Starts -->
  <div id="Middle-Div">  
  	...
  	<!-- Login Starts -->
    <form id="loginFrm" action="<?php echo base_url().index_page()."designer/login/doIt";?>" method="post">    
    <div id="Login-div">    
      <div id="Login-h1">
  ...
  <?php endif;?></div>
    ...
    <!-- Forgot Starts -->
     <form id="forgetFrm" action="<?php echo base_url().index_page()."designer/login/reset";?>" method="post">
    <div id="Forgot-pass">
