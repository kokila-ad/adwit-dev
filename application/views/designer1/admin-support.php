...
<div id="ad-form">
      ...
      <div id="ad-form-p">Adwit Admin Support</div>
	   <div id="ad-form-s">
      <form id="contactform1" name="contactform1" action="<?php echo base_url().index_page().'designer/home/admin_support';?>"  method="post"> 
...
<div id="ad-form">
      ...
      <div id="ad-form-p">Adwit IT Trouble Ticket</div>
	   <div id="ad-form-s">
      <form id="contactform2" name="contactform2" action="<?php echo base_url().index_page().'designer/home/trouble_ticket';?>" method="post"> 
	   <div id="ad-form-s-l">
