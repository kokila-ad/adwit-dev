 ...
 <tr>
 	<td>
		<p style="margin:30px 0 20px 0;">
			<a href="<?php echo $url; ?>" style="text-decoration:none;font-size:13px;background:#30a6c6;padding:8px 30px;border-radius:3px;color:white;outline:none;border:none;cursor:pointer;" >
