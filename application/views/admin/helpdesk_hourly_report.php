...
<script type="text/javascript">
	$(document).ready(function($) {
        $('#help_desk').change(function() {
            window.location = "<?php echo base_url().index_page().'admin/home/helpdesk_hourly_report/';?>" + $('#help_desk').val() ;
        });
    });
</script>
	<!-- BEGIN CONTENT -->
				...
				<!-- BEGIN EXAMPLE TABLE PORTLET-->
						<div class="portlet box green-haze">
							<div class="portlet-title">
								<div class="caption">
									Help Desk Hourly Revision Report : <?php if(isset($from) && isset($from)){ echo $from.' - '.$to; }else{ echo date('Y-m-d'); } ?>
								</div>
