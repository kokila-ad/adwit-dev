...
<div id="Middle-Div">
	...
	<div id="slug-view">
		<h2>ASSIGN TEAM</h2>
		<form method="post">
			<p style="margin: 5px 0;">Team Lead</p>
			<select class="select-style" id="team_lead" name="team_lead" required>
	...
	<div id="dp-view">
		...
		<div style="width:50%; float: left; margin: 0">
		<h2>TeamLead Check</h2>
			<form method="post">
				<p style="margin: 5px 0;">Team Lead</p><br/>
				<select class="select-style" id="team_lead" name="team_lead" required>
					<option value=''>Select</option>
				<?php foreach($team_lead as $row){ ?>
				...
				<div id="slug-btn">
				 <input name="teamlead_search" type="submit" value="search">
				</div>
				<br/>
			</form>
		</div>
