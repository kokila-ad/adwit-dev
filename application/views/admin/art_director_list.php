...
<script type="text/javascript" src="html2csv.js" ></script>
		...
		<div class="page-content-wrapper">
			<div class="page-content">
				...
				<div class="row">
					<div class="col-md-6">
						<h3 class="page-title">Art Director</h3>
					</div>
					<div class="col-md-6">
						<?php echo '<span style="color:#900;">'.$this->session->flashdata('art_director_successful').'</span>'; ?>
						<?php echo '<span style="color:#900;">'.$this->session->flashdata('art_director_updated_successful').'</span>'; ?>
					</div>
				</div>
				<!-- END PAGE HEADER-->
				...
				<!-- BEGIN EXAMPLE TABLE PORTLET-->
						<div class="portlet box green-haze">
							<div class="portlet-title">
								<div class="caption">
									<a data-toggle="modal" href="#addnew" type="button" class="btn btn-default btn-xs">
										<i class="fa fa-plus margin-right-10"></i>Add Art Director
									</a>
								</div>
							...
							<div class="portlet-body">
								...
								<tbody>
								<?php $i=0; foreach($art_director as $row) {  $i++;
								$business_groups_name = $this->db->query("SELECT * FROM `business_groups` WHERE `id` = '".$row['business_group_id']."'")->result_array();
								...
								<tr>
									...
									<td><?php if($row['business_group_id']=='0'){ echo "";}else{ echo $business_groups_name[0]['name']; }?></td>
								...
								<div id="edit<?php echo $i;?>" class="modal fade" tabindex="-1" data-width="760">
									<div class="modal-dialog modal-lg">
										...
										<form method="post" name="order_form" action="<?php echo base_url().index_page().'admin/home/art_director_update/'.$row['id'];?>" id="order_form">
											<div class="modal-header">
												<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
												<h4 class="modal-title">Edit Art Director</h4>
											</div>
								...
								<hr>				
												<div class="row">												
													...
													<div class="col-md-6">
														<div class="form-group">
															<label class="margin-top-5">Phone</label>
...
<div id="addnew" class="modal fade" tabindex="-1" data-width="760">
	<div class="modal-dialog modal-lg">
		...
		<form method="post" name="order_form" id="order_form">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
				<h4 class="modal-title">Add Art Director</h4>
			</div>
  	        <div class="modal-body">																																		
				<div class="row">
					<div class="col-md-6">
