     ...
     <div class="row-fluid" style="width:96%; margin: 0 auto;">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Outgoing Report : <?php if(isset($from) && isset($to)){echo $from." to ".$to;}else{echo $ystday;} ?> </div>
...
foreach($csr as $row)
{
	$new = 0; $revision = 0; $pickup = 0; $sold = 0; $fastrack = 0; 
			...
			if(isset($from) && isset($to))
			{
				...
				$outgoing = $this->db->query("SELECT * FROM `rev_sold_jobs` WHERE  `frontline_csr`='$csr_id' AND `date`='$ystday' ;")->result_array();			
			}
			
			foreach($outgoing as $row2)
			{
