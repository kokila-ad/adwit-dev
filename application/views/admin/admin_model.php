...
class Admin_model extends CI_Model {
	...
	{
		return $this->db->query("SELECT * FROM `business_groups`")->result_array();
		
	}
	
	public function art_director()
	{
		return $this->db->query("SELECT * FROM `art_director`")->result_array();
		
	}
	
	public function bg_head()
	{
		return $this->db->query("SELECT * FROM `bg_head`")->result_array();
	}
	...
	{
		return $this->db->query("SELECT * FROM `design_teams`")->result_array();
	}
	...
	{
		return $this->db->query("SELECT * FROM `adreps`")->result_array();
	}
	
	public function help_desk()
	{
		return $this->db->query("SELECT * FROM `help_desk`")->result_array();
	}
	...
	{
		return $this->db->query("SELECT * FROM `channels`")->result_array();
	}
	
	public function group()
	{
		return $this->db->query("SELECT * FROM `Group` ")->result_array();
	}
	...
	{
		return $this->db->query("SELECT * FROM `management`")->result_array();
	}
