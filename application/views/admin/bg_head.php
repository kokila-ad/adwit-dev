...
<script type="text/javascript" src="html2csv.js" ></script>
		...
		<div class="page-content-wrapper">
			<div class="page-content">
				...
				<div class="row">
					<div class="col-md-6">
						<h3 class="page-title">BusinessGroup Head</h3>
					</div>
					<div class="col-md-6">
						<?php echo '<span style="color:#900;">'.$this->session->flashdata('bg_head_successful').'</span>'; ?>
						<?php echo '<span style="color:#900;">'.$this->session->flashdata('bg_head_updated_successful').'</span>'; ?>
					</div>
				</div>
				<!-- END PAGE HEADER-->
				...
				<!-- BEGIN EXAMPLE TABLE PORTLET-->
						<div class="portlet box green-haze">
							<div class="portlet-title">
								<div class="caption">
									<a data-toggle="modal" href="#addnew" type="button" class="btn btn-default btn-xs">
										<i class="fa fa-plus margin-right-10"></i>Add BG Head
									</a>
								</div>
							...
							<div class="portlet-body">
								...
								<tbody>
								<?php $i=0; foreach($bg_head as $row) { $i++;
								...
								$work_location_name = $this->db->query("SELECT * FROM `location` WHERE `id` = '".$row['Work_location']."'")->result_array();
								?>
								<tr>
									...
									<td><?php if($row['Work_location']=='0'){ echo "";}else{ echo $work_location_name[0]['name']; } ?></td>
									...
									<div id="edit<?php echo $i;?>" class="modal fade" tabindex="-1" data-width="760">
										<div class="modal-dialog modal-lg">
											...
											<form method="post" name="order_form" action="<?php echo base_url().index_page().'admin/home/bg_head_update/'.$row['id'];?>" id="order_form">
												<div class="modal-header">
													<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
													<h4 class="modal-title">Edit BG Head</h4>
												</div>
...
<div id="addnew" class="modal fade" tabindex="-1" data-width="760">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
				<h4 class="modal-title">Add BG Head</h4>
			</div>
  	        <div class="modal-body">																																		
				<div class="row">
					<div class="col-md-6">
