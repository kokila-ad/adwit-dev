			...
			<div class="page-content">
				...
				<div class="portlet light">
					<div class="portlet-body">					
						<div class="row">
							<label class="col-lg-4 col-lg-offset-1 col-md-4 col-md-offset-1 col-sm-12 control-label text-right margin-top-5">Select Your Publication:</label>
							<div class="col-lg-3 col-md-4 col-sm-12">
								<select id="help_desk" name="help_desk" class="form-control">
									<option value="">Select</option>
									<?php
										$types = $this->db->query("SELECT * FROM `publications` WHERE `is_active` = '1' ORDER BY `name`")->result_array();
