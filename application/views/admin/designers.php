						...
						<div class="portlet box green-haze">
							...
							<div class="portlet-body">
								...
								<tr>
									...
									<td><?php if($row['Work_location']=='0'){ echo ""; }else { echo $location_name[0]['name']; }?></td>
									<?php if($row['is_active']==1) { ?>
									<td>
										<a data-toggle="modal" href="#edit<?php echo $i;?>" class="font-blue  margin-right-10"><i class="fa fa-edit"></i></a>
										<a title="" class="btn btn-danger btn-xs">Active</a>
									</td>
									<?php } else { ?>
									<td>
										<a data-toggle="modal" href="#edit<?php echo $i;?>" class="font-blue margin-right-10"><i class="fa fa-edit"></i></a>
										<a title="" class="btn btn-primary btn-xs">Deactive</a>
									</td>
									<?php } ?>
								</tr>
								<!--EDIT-->
			...
			<div class="modal-header">
  	         ...
  	         <div class="modal-body">																																	
				<div class="row">
					...
					<div class="col-md-6">
						<div class="form-group">
							<label class="margin-top-5">Email Id</label>
					...
					<div class="col-md-6">
						<div class="form-group">
								...
								<div class="clearfix">
									<div class="btn-group" data-toggle="buttons">
									<label class="btn btn-success <?php if($row['is_active']=='1')echo"active"; ?> active margin-right-10">
