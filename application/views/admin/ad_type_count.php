...
<script type="text/javascript">
	$(document).ready(function(e) {
        $('#help_desk').change(function(e) {
            window.location = "<?php echo base_url().index_page().'admin/home/ad_type_count/';?>" + $('#help_desk').val() ;
        });
    });
</script>
...
<div class="row-fluid" style="width: 96%; margin: 0 auto; ">
  <p style="text-align:center;"> 
        	...
        	<?php
			$types = $this->db->get_where('Group', array('is_active'=>'1'))->result_array();
  ...
  <div class="row-fluid" style="width:96%; margin: 0 auto;">  
    ...
    <div class="block">
      <div class="navbar navbar-inner block-header">
		...
		<div class="muted pull-left">Ads Count : <?php if(isset($from) && isset($to)){echo $from." to ".$to;}elseif(isset($today)){echo $today;} ?></div>
        ...
        <div class="span12">
          <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
            ...
            <tr>
				...
				<th rowspan="2" style="vertical-align: middle;">Print Ad</th>
				<th rowspan="2" style="vertical-align: middle;">Web Ad</th>
				<th rowspan="2" style="vertical-align: middle;">Print & Web Ad</th>
			</tr>
...
<?php
	foreach($grp_pub as $row1){
		$pid = $row1['id']; $orders_p = '0'; $orders_w = '0'; $orders_pw = '0';
		...
		if($orders){
			foreach($orders as $row){
				if($row['order_type_id']=='2'){ $orders_p++; }
				if($row['order_type_id']=='1'){ $orders_w++; }
				if($row['order_type_id']=='3'){ $orders_pw++; }
			}
		}
?>
              <tr class="odd gradeX">
				<td><?php echo $row1['name']; ?></td>
				<td><?php echo $orders_p; ?></td>
                <td><?php echo $orders_w; ?></td>
                <td><?php echo $orders_pw; ?></td>
			  </tr>
	<?php }  ?>
            </tbody>
          </table>
