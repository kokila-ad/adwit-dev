...
<head>
	...
	<link rel="stylesheet" href="stylesheet/style_india.css" type="text/css" />
...
<!-- Middle Starts -->
  <div id="Middle-Div">  
  	...
  	<!-- Login Starts -->
    <form id="loginFrm" action="<?php echo base_url().index_page()."india/login/doIt";?>" method="post">    
    <div id="Login-div">    
      <div id="Login-h1">
      Login to Write a Brief</div>
      <div id="Login-input">
  ...
  <?php endif;?></div>
      ...
      <p><a id="forget" href="javascript: void(0);">Forgot Your Password?</a></p>
      </div>
     </div> 
     </form>
     <!-- Login Ends -->
    ...
    <!-- Forgot Starts -->
     <form id="forgetFrm" action="<?php echo base_url().index_page()."india/login/reset";?>" method="post">
    <div id="Forgot-pass">
...
we'll reset your password.</div>
  ...
  <!-- Footer starts -->
  <div id="Footer">
  <div id="footer-copy">&copy; <a href="http://www.adwitindia.com/" target="_blank">Adwit India</a></div>
  <div id="footer-version">version 2.0</div>
  </div>
  <div>&nbsp;</div>
