...
<script type="text/javascript">
	...
	$(document).ready(function(e) {    
		...
		$('#pixel_size').change(function(e) {
            if($('#pixel_size').val()=='custom') $('#custom_pixel').show();
			else $('#custom_pixel').hide();
        });		
...
<table width="960" border="0" cellspacing="1" cellpadding="4">
  ...
  <tr style="background-color:#eee;">
    ...
    <td align="center" style="width: 288px; background-color: #eee;"><p style="padding: 0px; margin: 0px; color: #000; font-family:Tahoma, Geneva, sans-serif; font-size:14px;"><input name="" type="text" disabled="disabled"  value="<?php echo $client['email_id'];?>" style="width: 90%;"/></p></td>
    ...
    <td align="center" style="width: 288px; background-color: #eee;"><p style="padding: 0px; margin: 0px; color: #000; font-family:Tahoma, Geneva, sans-serif; font-size:14px;">
      <input type="text" id="publication_name" name="publication_name"  value="<?php echo set_value('publication_name');?>" style="width: 90%;" />
    </p></td>
    <!-- <td id="custom_pixel_01" style="width: 192px;"><p style="padding:10px; margin: 0px; color: #000; font-family:Tahoma, Geneva, sans-serif; font-size:14px;">Width (in Pixels)<span style="color:#F00;">*</span></p></td>
    <td id="custom_pixel_02" align="center" style="width: 288px; background-color: #eee;"><p style="padding: 0px; margin: 0px; color: #000; font-family:Tahoma, Geneva, sans-serif; font-size:14px;"><input name="width" type="text" id="width" value="<?php echo set_value('custom_width'); ?>" size="5"  style="width: 90%;" /></p></td> -->
  </tr>	 
  <tr style="background-color:#eee;">
    ...
    <td align="center" style="width: 288px; background-color: #eee;"><p style="padding: 0px; margin: 0px; color: #000; font-family:Tahoma, Geneva, sans-serif; font-size:14px;"><input type="text" id="advertiser_name" name="advertiser_name" value="<?php echo set_value('advertiser_name');?>" style="width: 90%;"/></p></td>
    ...
    <td align="center" style="width: 288px; background-color: #eee;"><p style="padding: 0px; margin: 0px; color: #000; font-family:Tahoma, Geneva, sans-serif; font-size:14px;">
	<select id="pixel_size" name="pixel_size" style="width: 92%;">
...
echo '<option value="'.$result['id'].'" '.set_select('pixel_size',$result['id']).' >'.$result['width'].' x '.$result['height'].'('.$result['name'].')'.'</option>';
  ...
  <tr style="background-color:#eee;">
    ...
    <td align="center" style="width: 288px; background-color: #eee;"><p style="padding: 0px; margin: 0px; color: #000; font-family:Tahoma, Geneva, sans-serif; font-size:14px;"><input type="text" id="job_no" name="job_no" value="<?php echo set_value('job_no'); ?>" style="width: 90%;" /></p></td>
  ...
  <tr style="background-color:#eee;">
    ...
    <td align="center" style="width: 288px; background-color: #eee;"><p style="padding: 0px; margin: 0px; color: #000; font-family:Tahoma, Geneva, sans-serif; font-size:14px;"><input type="text" id="date_needed" name="date_needed" value="<?php echo set_value('date_needed'); ?>" style="width: 90%;" /></p></td>
  ...
  <tr style="background-color:#eee;">
    ...
    <td align="center" style="width: 288px; background-color: #eee;"><p style="padding: 0px; margin: 0px; color: #000; font-family:Tahoma, Geneva, sans-serif; font-size:14px;"><select id="copy_content" name="copy_content" style="width: 92%;">
      <option value="">Select</option>
  ...
  <tr style="background-color:#eee; vertical-align: top;">
    ...
    <td align="center" style="width: 288px; background-color: #eee;"><p style="padding:7px 0 0 0;  margin: 0px; color: #000; font-family:Tahoma, Geneva, sans-serif; font-size:14px;"><select id="job_instruction" name="job_instruction" style="width: 92%;">
      <option value="">Select</option>
    ...
    <td align="center" style="width: 288px; background-color: #eee;"><p style="padding: 7px 0 0 0; margin: 0px; color: #000; font-family:Tahoma, Geneva, sans-serif; font-size:14px;">
      <input type="text" id="color_preferences" name="color_preferences"  value="<?php echo set_value('color_preferences');?>" style="width: 90%;" />
    </p></td>
    </tr>
  <tr style="background-color:#eee; vertical-align: top;">
    ...
    <td align="center" style="width: 288px; background-color: #eee;"><p style="padding:7px 0 0 0;  margin: 0px; color: #000; font-family:Tahoma, Geneva, sans-serif; font-size:14px;"><select id="art_work" name="art_work" style="width: 92%;">
      <option value="">Select</option>
    ...
    <td align="center" style="width: 288px; background-color: #eee;"><p style="padding:  7px 0 0 0; margin: 0px; color: #000; font-family:Tahoma, Geneva, sans-serif; font-size:14px;">
      <input type="text" id="font_preferences" name="font_preferences" value="<?php echo set_value('font_preferences');?>" style="width: 90%;" />
    </p></td>
    </tr>
  <tr style="background-color:#eee; vertical-align: top;">
    <td>&nbsp;</td>
