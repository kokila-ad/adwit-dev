...
<table width="960" border="0" cellspacing="1" cellpadding="4">
  ...
  <tr style="background-color:#eee;">
    ...
    <td align="center" style="width: 288px; background-color: #eee;"><p style="padding: 0px; margin: 0px; color: #000; font-family:Tahoma, Geneva, sans-serif; font-size:14px;">
      <input name="" type="text" disabled="disabled"  value="<?php echo $india['email_id'];?>" style="width: 90%;"/>
    </p></td>
  ...
  <td align="center" colspan="2">
   ...
   <!-- <td style="width: 192px;"><p style="padding: 10px; margin: 0px; color: #000; font-family:Tahoma, Geneva, sans-serif; font-size:14px;">Additional Material Sent<span style="color:#F00;">*</span></p></td>
    <td align="left" style="width: 288px; background-color: #eee;"><p style="padding: 10px; margin: 0px; color: #000; font-family:Tahoma, Geneva, sans-serif; font-size:14px;"><input type="checkbox" name="no_fax_items" id="no_fax_items" value="1"  <?php echo set_checkbox('no_fax_items', '1'); ?>/>&nbsp;Ftp&nbsp;&nbsp;<input type="checkbox" name="no_email_items" id="no_email_items" value="1"  <?php echo set_checkbox('no_email_items', '1'); ?> />&nbsp;Email</p></td> -->
  </tr>
  <tr style="background-color:#eee; vertical-align: top;">
