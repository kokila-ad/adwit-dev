		 ...
		 <div class="row ">             
           <div class="col-md-12 col-sm-6 col-xs-12 margin-top-20">
				<div class="row border">
					<div class="col-md-6 col-sm-6 col-xs-12 padding-top-25">			
				<!---- Start: Credit Balance ----->
					<div class="row margin-0">             
						<div class="col-md-12 col-sm-12 col-xs-12 center">
							 <p class="large margin-top-10">Credit Balance <span class="text-blue "><?php if(isset($var)){ echo $var[0]['free_credits']; } ?></span>
			 ...
			 End: Refer Friend ----->
					...
					<div class="col-md-6 col-sm-12 col-xs-12 padding-15 padding-top-25 border-left">
