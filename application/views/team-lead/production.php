...
<script type="text/javascript">
	$(document).ready(function(e) {
        $('#help_desk').change(function(e) {
            window.location = "<?php echo base_url().index_page().'team-lead/home/production_table/';?>" + $('#help_desk').val() ;
        });
    });
</script>
<script type="text/javascript">
  ...
  <p style="text-align:center;"> 
        	...
        	<?php
			$types = $this->db->get_where('teams',array('team_lead'=> $this->session->userdata('tId')))->result_array();
