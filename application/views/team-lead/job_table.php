...
<div class="row-fluid" style="width:96%; margin: 0 auto;">
                        ...
                        <div class="block">
								...
								<div class="muted pull-left"> <a href="<?php echo base_url().index_page().'team-lead/home/job_table';?>">All-Jobs</a> &nbsp &nbsp &nbsp
                                  <a href="<?php echo base_url().index_page().'team-lead/home/pending_list';?>">Pending Lists</a> </div>
...
<?php foreach($list as $row)	
		{?>									
											<tr class="odd gradeX">
												...
												<td> <?php if(!empty($row['designer'])) {
$designers = $this->db->get_where('designers',array('id' => $row['designer']))->result_array();
												echo $designers[0]['username']; } else{ echo "pending"; } ?></td>
												<td></td>
											</tr>
<?php }?>											
										</tbody>
