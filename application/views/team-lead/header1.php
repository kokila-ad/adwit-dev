...
<title>Team Lead @ Adwit Ads</title>
...
<!-- header Ends -->
<div id="Navigation-Tab-2">
<ul>
	 
     <li><a href="<?php echo base_url().index_page()."team-lead/home/change";?>">Change Password</a></li>
     <li><a href="<?php echo base_url().index_page()."team-lead/login/shutdown";?>">Logout</a></li>
    </ul>
</div>