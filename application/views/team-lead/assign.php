    ...
    <div class="page-content">
        ...
        <div class="navbar navbar-default" role="navigation">
								...
								<div class="navbar-header">
									...
									<!--<?php if(isset($form)){ ?>
									<a class="navbar-brand" href="<?php echo base_url().index_page().'team-lead/home/design_check/';?><?php echo $form; ?>">Design Check</a>
        ...
        <div class="col-md-12">
		 <form Method="POST" onsubmit="return myFunction(this)">	
					<div class="portlet light">
						...
						<a href="<?php echo base_url().index_page().'team-lead/home/design_check/';?><?php echo $form; ?>" class="btn btn-default">Design Check</a>
						<a class="btn btn-default" href="<?php echo base_url().index_page().'team-lead/home/all_pending/';?><?php echo $form; ?>">All Pending - <?php echo $orders_pending; ?></a>
				</div></div>
