...
<?php if(isset($orders[0]['id'])){ ?>
<div class="btn">
	<a href="<?php echo base_url().index_page().'cron_jobs/home/action_download_delete/'.$month; ?>"><button style="background-color:red">DELETE</button></a>
</div>
	<table border='1'>
		<thead>
		<tr>
