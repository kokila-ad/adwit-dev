...
.btn{ float:left; width:100%; padding:0px 0 10px; }
button{ padding:5px 40px;color:white;border:none; border-radius:2px; }
</style>
</head>
<body>
<h4>Revision Download Delete</h4>
<form method="GET" >
...
<?php if(isset($rev_orders[0]['id'])){ ?>
<div class="btn">
	<a href="<?php echo base_url().index_page().'cron_jobs/home/action_rev_delete/'.$month; ?>"><button style="background-color:red">DELETE</button></a>
</div>
	<table border='1'>
		<thead>
		<tr>
